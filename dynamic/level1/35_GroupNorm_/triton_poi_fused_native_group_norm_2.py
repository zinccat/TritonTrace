...
@triton.jit
def triton_poi_fused_native_group_norm_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ks0, ks1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (x6 // 8), xmask, eviction_policy='evict_last')
    tmp3 = tl.load(in_ptr2 + (x6 // 8), xmask, eviction_policy='evict_last')
    ...
    tmp12 = tmp10 * tmp11
    tmp14 = tmp12 + tmp13
    tl.store(out_ptr0 + (x0 + x7*(ks0 // ks1)), tmp14, xmask)

...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*i64', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'ks0': 'i32', 'xnumel': 'i32', 'rnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {'xnumel': 1}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3, 4), 'tt.equal_to': (6,)}, 'cls': 'AttrsDescriptor'})]},
...
@triton.jit
def triton_red_fused_nll_loss_forward_1(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, ks0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.device_assert(((0 <= tmp8) & (tmp8 < ks0)) | ~(rmask), "index out of bounds: 0 <= tmp8 < ks0")
        tmp10 = tl.load(in_ptr1 + (tmp8 + ks0*r0), rmask, eviction_policy='evict_last', other=0.0)
        tmp12 = tmp10 - tmp11

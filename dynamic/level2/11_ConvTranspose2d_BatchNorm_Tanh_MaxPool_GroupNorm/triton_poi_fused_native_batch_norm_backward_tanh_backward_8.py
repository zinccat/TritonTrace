...
def triton_poi_fused_native_batch_norm_backward_tanh_backward_8(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, ks0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tmp0 * tmp4
    tmp8 = tmp6 - tmp7
    tmp10 = (tl.full([], 1.00000000000000, tl.float64) / ((262144*ks0) / 64))

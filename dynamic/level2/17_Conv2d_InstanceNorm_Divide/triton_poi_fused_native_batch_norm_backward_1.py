...
def triton_poi_fused_native_batch_norm_backward_1(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tmp0 * tmp1
    tmp5 = tmp3 - tmp4
    tmp7 = (tl.full([], 1.00000000000000, tl.float64) / ((64*ks1 + ((-64)*ks1*ks2) + 16*ks1*ks2*ks2) / (16*ks1)))

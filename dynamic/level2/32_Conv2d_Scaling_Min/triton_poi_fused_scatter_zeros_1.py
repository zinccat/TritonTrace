...
@triton.jit
def triton_poi_fused_scatter_zeros_1(in_ptr0, in_ptr1, out_ptr0, ks0, ks1, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x3 + 4*tmp0 + 64*x4 + tmp0*ks1*ks1 + ((-64)*ks1*x4) + ((-4)*ks1*tmp0) + 16*x4*ks1*ks1), tmp2, xmask)

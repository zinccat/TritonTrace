...
@triton.jit
def triton_poi_fused_native_batch_norm_backward_4(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, ks0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tmp1 - tmp2
    tmp5 = (tl.full([], 1.00000000000000, tl.float64) / ((1024*ks0) / 1024))

...
@triton.jit
def triton_red_fused_mul_sum_0(in_ptr0, in_ptr1, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 16
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp3 = tl.load(in_ptr1 + (x0 + 16*r1), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp1 = 10.0
        tmp2 = tmp0 * tmp1
        tmp4 = tmp2 * tmp3

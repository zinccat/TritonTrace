...
def triton_poi_fused_avg_pool2d_backward_sub_tanh_tanh_backward_0(in_out_ptr0, in_ptr0, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp11 = tl.load(in_out_ptr0 + (x4), xmask, eviction_policy='evict_last')
    tmp1 = tmp0 / 4

...
def triton_poi_fused__softmax__softmax_backward_data_2(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + 8192*ks2*x2), None, eviction_policy='evict_last')
    tmp4 = tl.load(in_ptr1 + (x0 + 8192*ks2*x2), None, eviction_policy='evict_last')
    tmp7 = tl.load(in_ptr2 + (x0 + 8192*ks2*x2), None, eviction_policy='evict_last')
    tmp8 = tl.load(in_ptr3 + (x3), None, eviction_policy='evict_last')
    tmp2 = tmp0 - tmp1

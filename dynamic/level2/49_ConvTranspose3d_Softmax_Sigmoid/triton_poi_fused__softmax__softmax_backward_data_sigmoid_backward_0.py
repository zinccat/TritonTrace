...
def triton_poi_fused__softmax__softmax_backward_data_sigmoid_backward_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr2 + (x3), None, eviction_policy='evict_last')
    tmp7 = tl.load(in_ptr3 + (x0 + 8192*ks2*x2), None, eviction_policy='evict_last')
    tmp10 = tl.load(in_ptr4 + (x0 + 8192*ks2*x2), None, eviction_policy='evict_last')
    tmp2 = 1.0
    tmp3 = tmp2 - tmp1
    tmp4 = tmp1 * tmp3
    tmp5 = tmp0 * tmp4

...
def triton_red_fused_convolution_backward_3(in_ptr0, out_ptr0, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (64*((((r2 + 512*x1*ks1*ks1) // 64) % (128*ks1))) + 8192*ks1*x0 + 524288*ks1*((((r2 + 512*x1*ks1*ks1) // ks0) % ks1)) + ((r2 % 64))), rmask & xmask, eviction_policy='evict_last', other=0.0)

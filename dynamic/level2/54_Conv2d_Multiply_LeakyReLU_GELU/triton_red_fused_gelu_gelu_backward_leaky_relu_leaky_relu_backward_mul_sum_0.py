...
def triton_red_fused_gelu_gelu_backward_leaky_relu_leaky_relu_backward_mul_sum_0(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp6 = 0.0
        tmp7 = tmp5 > tmp6
        tmp8 = tl.load(in_ptr2 + (((-2)*((((r2 + x1*(triton_helpers.div_floor_integer(14 + 4*ks0 + ks0*ks1*ks1 + ((-4)*ks0*ks1),  15))) // ((-2) + ks1)) % ((-2) + ks1)))) + 4*x0 + 64*((((r2 + x1*(triton_helpers.div_floor_integer(14 + 4*ks0 + ks0*ks1*ks1 + ((-4)*ks0*ks1),  15))) // (4 + ks1*ks1 + ((-4)*ks1))) % ks0)) + ks1*((((r2 + x1*(triton_helpers.div_floor_integer(14 + 4*ks0 + ks0*ks1*ks1 + ((-4)*ks0*ks1),  15))) // ((-2) + ks1)) % ((-2) + ks1))) + x0*ks1*ks1 + ((-64)*ks1*((((r2 + x1*(triton_helpers.div_floor_integer(14 + 4*ks0 + ks0*ks1*ks1 + ((-4)*ks0*ks1),  15))) // (4 + ks1*ks1 + ((-4)*ks1))) % ks0))) + ((-4)*ks1*x0) + 16*ks1*ks1*((((r2 + x1*(triton_helpers.div_floor_integer(14 + 4*ks0 + ks0*ks1*ks1 + ((-4)*ks0*ks1),  15))) // (4 + ks1*ks1 + ((-4)*ks1))) % ks0)) + (((r2 + x1*(triton_helpers.div_floor_integer(14 + 4*ks0 + ks0*ks1*ks1 + ((-4)*ks0*ks1),  15))) % ((-2) + ks1)))), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)
        tmp9 = 0.01
        tmp10 = tmp5 * tmp9
        ...
        tmp27 = tmp8 * tmp26
        tmp28 = tmp27 * tmp9
        tmp29 = tl.where(tmp7, tmp27, tmp28)
        tmp30 = tmp29 * tmp3

...
def triton_poi_fused_scatter_zeros_1(in_ptr0, in_ptr1, out_ptr0, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x3 + ((-1)*tmp0) + ((-16)*x4) + ((-64)*x4*ks2*ks2) + ((-4)*tmp0*ks2*ks2) + 2*ks1*tmp0 + 4*ks2*tmp0 + 32*ks1*x4 + 64*ks2*x4 + ((-128)*ks1*ks2*x4) + ((-8)*ks1*ks2*tmp0) + 8*ks1*tmp0*ks2*ks2 + 128*ks1*x4*ks2*ks2), tmp2, xmask)

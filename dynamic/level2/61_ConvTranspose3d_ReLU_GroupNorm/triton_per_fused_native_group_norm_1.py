...
@triton.jit
def triton_per_fused_native_group_norm_1(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr):
    rnumel = 4
    ...
    tmp14 = tmp11[:, None]
    tmp15 = tmp12[:, None]
    tmp16 = 128 + 32*ks0*ks0 + 64*ks1 + 128*ks0 + 16*ks1*ks0*ks0 + 64*ks0*ks1

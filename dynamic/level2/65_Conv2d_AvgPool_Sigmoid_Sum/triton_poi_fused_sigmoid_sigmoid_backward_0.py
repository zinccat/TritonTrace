...
@triton.jit
def triton_poi_fused_sigmoid_sigmoid_backward_0(in_out_ptr0, in_ptr0, ks0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_out_ptr0 + (x2), xmask, eviction_policy='evict_last')

...
def triton_poi_fused_hardswish_backward_threshold_backward_0(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp12 = tmp10 + tmp11
    tmp13 = tmp8 * tmp12
    tmp14 = tl.where(tmp4, tmp13, tmp8)
    tmp15 = tl.where(tmp2, tmp7, tmp14)

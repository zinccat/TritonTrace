...
def triton_poi_fused__softmax_backward_data_1(in_out_ptr0, in_ptr0, in_ptr1, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr0 + (x4 + ((-8)*x6) + ((-2)*x6*ks3*ks3) + 4*ks2*x6 + 8*ks3*x6 + ks2*x6*ks3*ks3 + ((-4)*ks2*ks3*x6)), xmask, eviction_policy='evict_last')

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_2(in_ptr0, out_ptr0, out_ptr1, out_ptr2, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 3984
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp2 = tmp0 < tmp1
        tmp3 = tl.load(in_ptr0 + (((-1)*x1) + ((-1)*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // ((-1) + 2*ks1)) % ((-1) + 2*ks1)))) + ((-16)*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // ((-1) + ((-12)*ks1*ks1) + 6*ks1 + 8*ks1*ks1*ks1)) % ks0))) + ((-192)*ks1*ks1*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // ((-1) + ((-12)*ks1*ks1) + 6*ks1 + 8*ks1*ks1*ks1)) % ks0))) + ((-12)*x1*ks1*ks1) + ((-4)*ks1*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // (1 + ((-4)*ks1) + 4*ks1*ks1)) % ((-1) + 2*ks1)))) + 2*ks1*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // ((-1) + 2*ks1)) % ((-1) + 2*ks1))) + 4*ks1*ks1*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // (1 + ((-4)*ks1) + 4*ks1*ks1)) % ((-1) + 2*ks1))) + 6*ks1*x1 + 8*x1*ks1*ks1*ks1 + 96*ks1*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // ((-1) + ((-12)*ks1*ks1) + 6*ks1 + 8*ks1*ks1*ks1)) % ks0)) + 128*ks1*ks1*ks1*((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // ((-1) + ((-12)*ks1*ks1) + 6*ks1 + 8*ks1*ks1*ks1)) % ks0)) + (((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) % ((-1) + 2*ks1))) + ((((r2 + x0*(triton_helpers.div_floor_integer(248 + ((-1)*ks0) + ((-12)*ks0*ks1*ks1) + 6*ks0*ks1 + 8*ks0*ks1*ks1*ks1,  249))) // (1 + ((-4)*ks1) + 4*ks1*ks1)) % ((-1) + 2*ks1)))), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)
        tmp4 = 0.0

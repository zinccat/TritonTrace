...
def triton_poi_fused__native_batch_norm_legit_functional_mul_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tmp0 - tmp1
    tmp4 = 4*ks1 + ks1*ks2*ks2 + ((-4)*ks1*ks2)

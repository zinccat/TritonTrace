...
@triton.jit
def triton_red_fused_convolution_backward_3(in_ptr0, out_ptr0, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 352
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp1 = 2048*ks0*ks0
        tmp2 = tmp0 < tmp1
        tmp3 = tl.load(in_ptr0 + (128*x0*ks0*ks0 + 4096*ks0*ks0*((((r2 + x1*((10 + 2048*ks0*ks0) // 11)) // ks1) % 16)) + (((r2 + x1*((10 + 2048*ks0*ks0) // 11)) % ks1))), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)

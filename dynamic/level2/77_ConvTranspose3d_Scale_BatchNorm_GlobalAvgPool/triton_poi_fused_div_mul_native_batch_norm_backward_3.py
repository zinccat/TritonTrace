...
def triton_poi_fused_div_mul_native_batch_norm_backward_3(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp4 * tmp5
    tmp8 = tmp6 - tmp7
    tmp10 = (tl.full([], 1.00000000000000, tl.float64) / ((128*ks2*ks2 + 256*ks2 + 32*ks2*ks2*ks3*ks3 + 64*ks2*ks3*ks3 + 128*ks3*ks2*ks2 + 256*ks2*ks3) / 32))
    ...
    tmp23 = tmp20 * tmp22
    tmp24 = tmp23 * tmp5
    tl.store(in_out_ptr0 + (x5), tmp24, xmask)

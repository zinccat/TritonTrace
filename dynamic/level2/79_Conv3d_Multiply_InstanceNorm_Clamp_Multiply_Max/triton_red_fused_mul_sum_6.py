...
@triton_heuristics.reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused_mul_sum_6', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 1, 'backend_hash': '5A06A9183D03767BDAB0FC92F89F8279B36CCC7C4B95A264F6D3CCE126D2D3A0', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_red_fused_mul_sum_6(in_ptr0, in_ptr1, out_ptr0, ks0, ks1, ks2, ks3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 336
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp4 = tl.load(in_ptr1 + (((-128)*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ks3) % ks0))) + ((-8)*x0) + ((-2)*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ((-2) + ks2)) % ((-2) + ks2)))) + 4*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // (4 + ks2*ks2 + ((-4)*ks2))) % ((-2) + ks1))) + ks2*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ((-2) + ks2)) % ((-2) + ks2))) + ks2*ks2*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // (4 + ks2*ks2 + ((-4)*ks2))) % ((-2) + ks1))) + ((-32)*ks2*ks2*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ks3) % ks0))) + ((-4)*ks2*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // (4 + ks2*ks2 + ((-4)*ks2))) % ((-2) + ks1)))) + ((-2)*x0*ks2*ks2) + 4*ks1*x0 + 8*ks2*x0 + 64*ks1*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ks3) % ks0)) + 128*ks2*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ks3) % ks0)) + ks1*x0*ks2*ks2 + ((-64)*ks1*ks2*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ks3) % ks0))) + ((-4)*ks1*ks2*x0) + 16*ks1*ks2*ks2*((((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) // ks3) % ks0)) + (((r2 + x1*(triton_helpers.div_floor_integer(20 + ((-8)*ks0) + ((-2)*ks0*ks2*ks2) + 4*ks0*ks1 + 8*ks0*ks2 + ks0*ks1*ks2*ks2 + ((-4)*ks0*ks1*ks2),  21))) % ((-2) + ks2)))), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)
        tmp5 = tmp3 * tmp4

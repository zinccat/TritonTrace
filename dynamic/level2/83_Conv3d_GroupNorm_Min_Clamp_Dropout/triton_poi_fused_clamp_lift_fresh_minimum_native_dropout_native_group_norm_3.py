...
def triton_poi_fused_clamp_lift_fresh_minimum_native_dropout_native_group_norm_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, ks0, ks1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tl.load(in_ptr3 + (x5 // 2), xmask, eviction_policy='evict_last')

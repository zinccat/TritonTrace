...
def triton_per_fused__softmax_backward_data_add_mul_sigmoid_sigmoid_backward_sub_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ks0, ks1, ks2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (x0 + ks1*r2*ks2*ks2 + 16*ks1*x1*ks2*ks2), xmask, eviction_policy='evict_last', other=0.0)

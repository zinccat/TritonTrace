...
def triton_poi_fused_add_div_mul_native_batch_norm_backward_sigmoid_sigmoid_backward_4(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, ks0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp10 = tmp9 * tmp5
    tmp13 = tmp11 - tmp12
    tmp15 = (tl.full([], 1.00000000000000, tl.float64) / ((512*ks0) / 512))

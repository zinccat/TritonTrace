...
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, out_ptr4, out_ptr6, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 192
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        r1 = rindex % ks0
        r2 = (rindex // ks0)
        tmp0 = tl.load(in_ptr0 + (r1 + (ks0*x0) + (192*ks0*r2)), rmask & xmask, eviction_policy='evict_last', other=0.0)
    ...
    tmp11 = ((192*ks0*ks1) / 192) / ((-1.00000000000000) + ((192*ks0*ks1) / 192))

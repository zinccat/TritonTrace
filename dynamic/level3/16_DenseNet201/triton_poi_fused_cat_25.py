...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp23 = tmp0 < tmp22
    tmp24 = tmp21 & tmp23
    tmp25 = tl.load(in_ptr4 + (x3 + (32*x5) + (((triton_helpers.div_floor_integer((-1) + ks3,  4))*(triton_helpers.div_floor_integer((-1) + ks3,  4)))*((-160) + x4)) + (2*(triton_helpers.div_floor_integer((-1) + ks3,  4))*((-160) + x4)) + (32*x5*((triton_helpers.div_floor_integer((-1) + ks3,  4))*(triton_helpers.div_floor_integer((-1) + ks3,  4)))) + (64*x5*(triton_helpers.div_floor_integer((-1) + ks3,  4))) + ((-160) + x4)), tmp24 & xmask, eviction_policy='evict_last', other=0.0)
    tmp26 = tmp0 >= tmp22
    tmp27 = tl.full([1], 224, tl.int64)
    tmp28 = tmp0 < tmp27
    tmp29 = tmp26 & tmp28
    tmp30 = tl.load(in_ptr5 + (x3 + (32*x5) + (((triton_helpers.div_floor_integer((-1) + ks3,  4))*(triton_helpers.div_floor_integer((-1) + ks3,  4)))*((-192) + x4)) + (2*(triton_helpers.div_floor_integer((-1) + ks3,  4))*((-192) + x4)) + (32*x5*((triton_helpers.div_floor_integer((-1) + ks3,  4))*(triton_helpers.div_floor_integer((-1) + ks3,  4)))) + (64*x5*(triton_helpers.div_floor_integer((-1) + ks3,  4))) + ((-192) + x4)), tmp29 & xmask, eviction_policy='evict_last', other=0.0)
    tmp31 = tmp0 >= tmp27
    tmp32 = tl.full([1], 256, tl.int64)
    tmp33 = tmp0 < tmp32
    tmp34 = tl.load(in_ptr6 + (x3 + (32*x5) + (((triton_helpers.div_floor_integer((-1) + ks3,  4))*(triton_helpers.div_floor_integer((-1) + ks3,  4)))*((-224) + x4)) + (2*(triton_helpers.div_floor_integer((-1) + ks3,  4))*((-224) + x4)) + (32*x5*((triton_helpers.div_floor_integer((-1) + ks3,  4))*(triton_helpers.div_floor_integer((-1) + ks3,  4)))) + (64*x5*(triton_helpers.div_floor_integer((-1) + ks3,  4))) + ((-224) + x4)), tmp31 & xmask, eviction_policy='evict_last', other=0.0)

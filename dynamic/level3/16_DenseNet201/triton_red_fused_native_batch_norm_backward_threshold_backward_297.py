...
@triton_heuristics.reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_batch_norm_backward_threshold_backward_297', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 2, 'backend_hash': '712B1D69F892A891D8FFA5075DCAB47CFF4E132D88BFC66744701CEAE226F127', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, ks0, ks1, ks2, ks3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp4 = 0.0
        tmp5 = tmp3 <= tmp4
        tmp6 = tl.load(in_ptr1 + (x0 + (128*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks3) % ks0)) + (x0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + ((triton_helpers.div_floor_integer((-1) + ks1,  4))*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks2) % ks2)) + (2*x0*(triton_helpers.div_floor_integer((-1) + ks1,  4))) + (128*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks3) % ks0)) + (256*(triton_helpers.div_floor_integer((-1) + ks1,  4))*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks3) % ks0)) + ((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) % ks2) + (((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks2) % ks2)), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp13 = tl.load(in_ptr2 + (x0 + (128*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks3) % ks0)) + (x0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + ((triton_helpers.div_floor_integer((-1) + ks1,  4))*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks2) % ks2)) + (2*x0*(triton_helpers.div_floor_integer((-1) + ks1,  4))) + (128*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks3) % ks0)) + (256*(triton_helpers.div_floor_integer((-1) + ks1,  4))*(((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks3) % ks0)) + ((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) % ks2) + (((r2 + (x1*(triton_helpers.div_floor_integer(3 + ks0 + (ks0*((triton_helpers.div_floor_integer((-1) + ks1,  4))*(triton_helpers.div_floor_integer((-1) + ks1,  4)))) + (2*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  4))),  4)))) // ks2) % ks2)), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)

...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, out_ptr2, out_ptr4, out_ptr6, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp26 = tmp24 * tmp25
    tmp27 = tmp23 + tmp26
    tmp28 = (((64*ks0) + (64*ks0*((triton_helpers.div_floor_integer((-1) + ks1,  2))*(triton_helpers.div_floor_integer((-1) + ks1,  2)))) + (128*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  2)))) / 64) / ((-1.00000000000000) + (((64*ks0) + (64*ks0*((triton_helpers.div_floor_integer((-1) + ks1,  2))*(triton_helpers.div_floor_integer((-1) + ks1,  2)))) + (128*ks0*(triton_helpers.div_floor_integer((-1) + ks1,  2)))) / 64))

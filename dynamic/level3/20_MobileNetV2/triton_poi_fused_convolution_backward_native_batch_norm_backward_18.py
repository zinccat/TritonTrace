...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tmp1 - tmp2
    tmp5 = 1.00000000000000 / (((96*ks1) + (96*ks1*((triton_helpers.div_floor_integer((-1) + ks2,  16))*(triton_helpers.div_floor_integer((-1) + ks2,  16)))) + (192*ks1*(triton_helpers.div_floor_integer((-1) + ks2,  16)))) / 96)

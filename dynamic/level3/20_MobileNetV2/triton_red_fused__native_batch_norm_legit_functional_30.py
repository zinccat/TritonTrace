...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, out_ptr4, out_ptr6, ks0, ks1, ks2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    tmp15 = tmp13 * tmp14
    tmp16 = tmp12 + tmp15
    tmp17 = (((96*ks2) + (96*ks2*((triton_helpers.div_floor_integer((-1) + ks1,  16))*(triton_helpers.div_floor_integer((-1) + ks1,  16)))) + (192*ks2*(triton_helpers.div_floor_integer((-1) + ks1,  16)))) / 96) / ((-1.00000000000000) + (((96*ks2) + (96*ks2*((triton_helpers.div_floor_integer((-1) + ks1,  16))*(triton_helpers.div_floor_integer((-1) + ks1,  16)))) + (192*ks2*(triton_helpers.div_floor_integer((-1) + ks1,  16)))) / 96))

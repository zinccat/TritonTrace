...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tmp1 - tmp2
    tmp5 = 1.00000000000000 / (((192*ks1) + (192*ks1*((triton_helpers.div_floor_integer((-1) + ks2,  2))*(triton_helpers.div_floor_integer((-1) + ks2,  2)))) + (384*ks1*(triton_helpers.div_floor_integer((-1) + ks2,  2)))) / 192)

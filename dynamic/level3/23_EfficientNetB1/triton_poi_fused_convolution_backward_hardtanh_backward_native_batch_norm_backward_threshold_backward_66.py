...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp10 = tmp8 - tmp9
    tmp12 = 1.00000000000000 / (((32*ks1) + (32*ks1*((triton_helpers.div_floor_integer((-1) + ks2,  2))*(triton_helpers.div_floor_integer((-1) + ks2,  2)))) + (64*ks1*(triton_helpers.div_floor_integer((-1) + ks2,  2)))) / 32)

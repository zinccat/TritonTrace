...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, rnumel):
    ...
    tmp13 = tl.load(in_out_ptr0 + (r2 + (768*x3)), rmask, other=0.0)
    ...
    tmp20 = tmp14 * tmp19
    tmp21 = tmp13 + tmp20
    tl.store(in_out_ptr0 + (r2 + (768*x3)), tmp21, rmask)

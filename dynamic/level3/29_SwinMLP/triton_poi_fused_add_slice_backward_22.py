...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_slice_backward_22', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': '712B1D69F892A891D8FFA5075DCAB47CFF4E132D88BFC66744701CEAE226F127', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
...
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp11 = tmp8 & tmp10
    tmp12 = tmp11 & tmp6
    tmp13 = tl.load(in_ptr0 + (1152 + x0 + (1536*(triton_helpers.div_floor_integer((-1) + x1,  2))) + (10752*(triton_helpers.div_floor_integer((-1) + x2,  2))) + (75264*x3)), tmp12 & xmask, other=0.0)
    tmp14 = 0.0
    ...
    tmp20 = tmp19 == tmp4
    tmp21 = tmp11 & tmp20
    tmp22 = tl.load(in_ptr0 + (768 + x0 + (1536*(triton_helpers.div_floor_integer((-1) + x1,  2))) + (10752*(x2 // 2)) + (75264*x3)), tmp21 & xmask, other=0.0)
    ...
    tmp29 = tmp28 == tmp4
    tmp30 = tmp29 & tmp6
    tmp31 = tl.load(in_ptr0 + (384 + x0 + (1536*(x1 // 2)) + (10752*(triton_helpers.div_floor_integer((-1) + x2,  2))) + (75264*x3)), tmp30 & xmask, other=0.0)
    ...
    tmp36 = tmp27 + tmp35
    tmp37 = tmp29 & tmp20
    tmp38 = tl.load(in_ptr0 + (x0 + (1536*(x1 // 2)) + (10752*(x2 // 2)) + (75264*x3)), tmp37 & xmask, other=0.0)

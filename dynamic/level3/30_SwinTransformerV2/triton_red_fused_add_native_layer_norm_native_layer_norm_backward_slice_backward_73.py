...
@triton_heuristics.reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_native_layer_norm_backward_slice_backward_73', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 12, 'num_reduction': 2, 'backend_hash': '712B1D69F892A891D8FFA5075DCAB47CFF4E132D88BFC66744701CEAE226F127', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp53 = tl.load(in_ptr2 + (r3 + (192*x6)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp0 = x1
        ...
        tmp11 = tmp8 & tmp10
        tmp12 = tmp11 & tmp6
        tmp13 = tl.load(in_ptr0 + (576 + r3 + (768*(triton_helpers.div_floor_integer((-1) + x0,  2))) + (10752*(triton_helpers.div_floor_integer((-1) + x1,  2))) + (150528*x2)), rmask & tmp12 & xmask, eviction_policy='evict_last', other=0.0)
        tmp14 = 0.0
        ...
        tmp20 = tmp19 == tmp4
        tmp21 = tmp11 & tmp20
        tmp22 = tl.load(in_ptr0 + (384 + r3 + (768*(triton_helpers.div_floor_integer((-1) + x0,  2))) + (10752*(x1 // 2)) + (150528*x2)), rmask & tmp21 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp29 = tmp28 == tmp4
        tmp30 = tmp29 & tmp6
        tmp31 = tl.load(in_ptr0 + (192 + r3 + (768*(x0 // 2)) + (10752*(triton_helpers.div_floor_integer((-1) + x1,  2))) + (150528*x2)), rmask & tmp30 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp37 = ((x6 % 784) // 28) % 2
        tmp38 = tmp37 == tmp4
        tmp39 = tl.broadcast_to((x4 % 28) % 2, [XBLOCK, RBLOCK])
        tmp40 = tmp39 == tmp4
        tmp41 = tmp40 & tmp38
        tmp42 = tl.load(in_ptr0 + (r3 + (768*((x4 % 28) // 2)) + (10752*(x4 // 56)) + (150528*x2)), rmask & tmp41 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tl.store(out_ptr0 + (r3 + (192*x6)), tmp36, rmask & xmask)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r3 = rindex
        tmp64 = tl.load(out_ptr0 + (r3 + (192*x6)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp78 = tl.load(in_ptr1 + (r3), rmask, eviction_policy='evict_last', other=0.0)
        tmp83 = tl.load(in_ptr2 + (r3 + (192*x6)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp62 = 0.005208333333333333
        tmp63 = tmp56 * tmp62
        tmp65 = ((x6 % 784) // 28) % 2
        tmp66 = tl.full([1, 1], 0, tl.int64)
        tmp67 = tmp65 == tmp66
        tmp68 = tl.broadcast_to((x4 % 28) % 2, [XBLOCK, RBLOCK])
        tmp69 = tmp68 == tmp66
        tmp70 = tmp69 & tmp67
        tmp71 = tl.load(in_ptr0 + (r3 + (768*((x4 % 28) // 2)) + (10752*(x4 // 56)) + (150528*x2)), rmask & tmp70 & xmask, eviction_policy='evict_first', other=0.0)
        tmp72 = 0.0
        ...
        tmp87 = tmp82 - tmp86
        tmp88 = tmp63 * tmp87
        tl.store(out_ptr3 + (r3 + (192*x6)), tmp88, rmask & xmask)

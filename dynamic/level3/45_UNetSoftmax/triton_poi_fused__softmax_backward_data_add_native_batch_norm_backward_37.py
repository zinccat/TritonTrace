...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, ks0, ks1, ks2, ks3, ks4, ks5, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr1 + (x1 + (2*ks3*x6)), None, eviction_policy='evict_last')
    tmp3 = tl.load(in_ptr2 + (x0 + (2*ks5*x1) + (2048*ks3*ks5) + (4*ks3*ks5*x2) + (4096*ks3*ks5*x3)), None, eviction_policy='evict_last')
    ...
    tmp10 = tmp8 - tmp9
    tmp12 = 1.00000000000000 / ((4096*ks0*ks1) / 512)

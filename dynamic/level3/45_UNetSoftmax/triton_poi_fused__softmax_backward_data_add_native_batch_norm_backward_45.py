...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_backward_data_add_native_batch_norm_backward_45', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 10, 'num_reduction': 0, 'backend_hash': '712B1D69F892A891D8FFA5075DCAB47CFF4E132D88BFC66744701CEAE226F127', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, ks0, ks1, ks2, ks3, ks4, ks5, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr1 + (x1 + (4*ks3*x6)), None, eviction_policy='evict_last')
    tmp3 = tl.load(in_ptr2 + (x0 + (4*ks5*x1) + (4096*ks3*ks5) + (16*ks3*ks5*x2) + (8192*ks3*ks5*x3)), None, eviction_policy='evict_last')
    tmp4 = tl.load(in_out_ptr0 + (x5), None, eviction_policy='evict_last')
    ...
    tmp15 = tl.load(in_ptr6 + (x2), None, eviction_policy='evict_last')
    ...
    tmp10 = tmp8 - tmp9
    tmp12 = 1.00000000000000 / ((2048*ks0*ks1) / 256)
    ...
    tmp24 = tmp15 * tmp23
    tmp25 = tmp22 * tmp24
    tl.store(in_out_ptr0 + (x5), tmp25, None)

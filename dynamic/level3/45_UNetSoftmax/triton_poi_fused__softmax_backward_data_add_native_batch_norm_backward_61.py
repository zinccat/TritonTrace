...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, ks0, ks1, ks2, ks3, ks4, ks5, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr1 + (x1 + (16*ks3*x6)), xmask, eviction_policy='evict_last')
    tmp3 = tl.load(in_ptr2 + (x0 + (16*ks5*x1) + (16384*ks3*ks5) + (256*ks3*ks5*x2) + (32768*ks3*ks5*x3)), xmask, eviction_policy='evict_last')
    ...
    tmp10 = tmp8 - tmp9
    tmp12 = 1.00000000000000 / ((512*ks0*ks1) / 64)

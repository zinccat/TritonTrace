...
def triton_(in_ptr0, in_ptr1, out_ptr0, ks0, ks1, ks2, ks3, ks4, xnumel, XBLOCK : tl.constexpr):
    ...
    x4 = xindex % ks2
    x5 = xindex
    tmp0 = tl.load(in_ptr0 + ((ks3*((((0) * ((0) >= ((x1 // 2))) + ((x1 // 2)) * (((x1 // 2)) > (0)))) * ((((0) * ((0) >= ((x1 // 2))) + ((x1 // 2)) * (((x1 // 2)) > (0)))) <= ((-1) + ((ks4) * ((ks4) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (ks4))))) + ((-1) + ((ks4) * ((ks4) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (ks4)))) * (((-1) + ((ks4) * ((ks4) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (ks4)))) < (((0) * ((0) >= ((x1 // 2))) + ((x1 // 2)) * (((x1 // 2)) > (0))))))) + (ks3*ks4*x2) + ((((0) * ((0) >= ((x0 // 2))) + ((x0 // 2)) * (((x0 // 2)) > (0)))) * ((((0) * ((0) >= ((x0 // 2))) + ((x0 // 2)) * (((x0 // 2)) > (0)))) <= ((-1) + ((ks3) * ((ks3) <= (1 + (x0 // 2))) + (1 + (x0 // 2)) * ((1 + (x0 // 2)) < (ks3))))) + ((-1) + ((ks3) * ((ks3) <= (1 + (x0 // 2))) + (1 + (x0 // 2)) * ((1 + (x0 // 2)) < (ks3)))) * (((-1) + ((ks3) * ((ks3) <= (1 + (x0 // 2))) + (1 + (x0 // 2)) * ((1 + (x0 // 2)) < (ks3)))) < (((0) * ((0) >= ((x0 // 2))) + ((x0 // 2)) * (((x0 // 2)) > (0))))))), xmask, eviction_policy='evict_last')

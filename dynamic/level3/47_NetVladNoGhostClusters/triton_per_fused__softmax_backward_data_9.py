...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ks0, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    r1 = rindex
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + ((ks0*r1) + (32*ks0*(x0 // ks0)) + (x0 % ks0)), xmask, eviction_policy='evict_last', other=0.0)
    tmp1 = tl.load(in_ptr1 + (r1 + (32*(x0 // ks0))), xmask, other=0.0)

...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr0, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp9 = tmp7 - tmp8
    tmp11 = 1.00000000000000 / (((512*ks2) + (512*ks2*((triton_helpers.div_floor_integer((-1) + ks3,  32))*(triton_helpers.div_floor_integer((-1) + ks3,  32)))) + (1024*ks2*(triton_helpers.div_floor_integer((-1) + ks3,  32)))) / 512)

...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, out_ptr2, out_ptr3, out_ptr4, out_ptr5, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp4 = tl.load(in_ptr1 + (r3 + x0 + (128*r4) + (x0*((triton_helpers.div_floor_integer((-1) + ks1,  8))*(triton_helpers.div_floor_integer((-1) + ks1,  8)))) + (2*x0*(triton_helpers.div_floor_integer((-1) + ks1,  8))) + (128*r4*((triton_helpers.div_floor_integer((-1) + ks1,  8))*(triton_helpers.div_floor_integer((-1) + ks1,  8)))) + (256*r4*(triton_helpers.div_floor_integer((-1) + ks1,  8)))), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp11 = tl.load(in_ptr3 + (r3 + x0 + (128*r4) + (x0*((triton_helpers.div_floor_integer((-1) + ks1,  8))*(triton_helpers.div_floor_integer((-1) + ks1,  8)))) + (2*x0*(triton_helpers.div_floor_integer((-1) + ks1,  8))) + (128*r4*((triton_helpers.div_floor_integer((-1) + ks1,  8))*(triton_helpers.div_floor_integer((-1) + ks1,  8)))) + (256*r4*(triton_helpers.div_floor_integer((-1) + ks1,  8)))), rmask & xmask, eviction_policy='evict_last', other=0.0)

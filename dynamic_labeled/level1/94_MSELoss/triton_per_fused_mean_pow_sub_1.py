...
@triton.jit
def triton_per_fused_mean_pow_sub_1(in_out_ptr0, in_ptr0, kernel_size0, kernel_size1, xnumel, rnumel, XBLOCK: tl.constexpr):
    ...
    mean_values = summed_values / kernel_product_float
    tl.debug_barrier()

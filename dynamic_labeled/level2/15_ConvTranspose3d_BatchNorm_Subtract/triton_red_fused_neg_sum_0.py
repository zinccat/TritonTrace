...
@triton.jit
def triton_red_fused_neg_sum_0(in_ptr0, out_ptr0, kernel_size, total_elements, reduction_elements, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    total_elements = 512
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        loaded_values = tl.load(
            in_ptr0 + (r_indices_flat + 31 * x_indices_flat + ((-124) * kernel_size * x_indices_flat) + 124 * x_indices_flat * kernel_size * kernel_size),
            r_mask & x_mask,

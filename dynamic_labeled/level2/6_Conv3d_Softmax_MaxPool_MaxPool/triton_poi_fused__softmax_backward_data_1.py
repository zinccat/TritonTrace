...
@triton.jit
def triton_poi_fused__softmax_backward_data_1(in_out_ptr0, in_ptr0, in_ptr1, kernel_size0, kernel_size1, kernel_size2, kernel_size3, num_elements, XBLOCK : tl.constexpr):
    ...
    negated_value = -loaded_value
    product = loaded_input1 * loaded_value
    fused_multiply_add = tl.extra.cuda.libdevice.fma(negated_value, loaded_input0, product)

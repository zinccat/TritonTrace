...
@triton.jit
def triton_poi_fused_mul_8(in_out_ptr0, in_ptr0, kernel_size, num_elements, XBLOCK: tl.constexpr):
    ...
    multiplied_data = output_data * input_data
    tl.store(in_out_ptr0 + (linear_index), multiplied_data, valid_mask)
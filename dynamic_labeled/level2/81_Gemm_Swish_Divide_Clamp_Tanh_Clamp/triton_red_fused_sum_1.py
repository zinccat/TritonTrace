...
@triton.jit
def triton_red_fused_sum_1(input_ptr0, output_ptr0, num_elements_x, num_elements_r, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    num_elements_x = 512
    ...
    for r_offset in range(0, num_elements_r, RBLOCK):
        ...
        loaded_values = tl.load(input_ptr0 + (x_indices_0 + 512 * r_indices_1), r_mask & x_mask, eviction_policy='evict_first', other=0.0)
    ...
    tl.store(output_ptr0 + (x_indices_0), summed_values, x_mask)
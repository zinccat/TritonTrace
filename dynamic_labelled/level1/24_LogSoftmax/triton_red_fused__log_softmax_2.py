...
@triton.jit
def triton_red_fused__log_softmax_2red_fused__log_softmax_2(in_ptr0, in_ptr1, out_ptr0, kernel_size, input_num_elements, reduction_num_elements, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):

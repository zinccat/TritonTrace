...
@triton.jit
def triton_per_fused_smooth_l1_loss_1per_fused_smooth_l1_loss_1(in_out_ptr0, in_ptr0, kernel_size0, kernel_size1, xnumel, rnumel, XBLOCK: tl.constexpr):
    ...
    result = sum_values / kernel_product_float
    tl.debug_barrier()

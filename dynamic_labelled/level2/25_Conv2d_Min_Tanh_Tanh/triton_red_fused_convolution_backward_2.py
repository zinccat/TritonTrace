        ...
        temp_load = tl.load(
            in_ptr0 + (
                (-2) * (
                    ...
                    (((reduction_index_2 + input_index_1 * (triton_helpers.div_floor_integer(14 + 4 * kernel_size0 + kernel_size0 * kernel_size1 * kernel_size1 + (-4) * kernel_size0 * kernel_size1, 15))) // kernel_size2) % kernel_size0)
                ) + kernel_size1 * (
                    (((reduction_index_2 + input_index_1 * (triton_helpers.div_floor_integer(14 + 4 * kernel_size0 + kernel_size0 * kernel_size1 * kernel_size1 + (-4) * kernel_size0 * kernel_size1, 15))) // (-2 + kernel_size1)) % (-2 + kernel_size1))

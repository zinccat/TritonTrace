...
@triton.jit
def triton_poi_fused_add_convolution_hardswish_mul_0poi_fused_add_convolution_hardswish_mul_0(in_out_ptr0, in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):

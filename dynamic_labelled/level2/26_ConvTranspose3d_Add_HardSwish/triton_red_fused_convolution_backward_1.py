...
@triton.jit
def triton_red_fused_convolution_backward_1red_fused_convolution_backward_1(in_ptr0, out_ptr0, kernel_size, input_num_elements, output_num_elements, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):

...
@triton.jit
def triton_per_fused_sum_0per_fused_sum_0(input_ptr, output_ptr, kernel_size_0, kernel_size_1, input_num_elements, reduction_num_elements, XBLOCK: tl.constexpr):
    ...
    tl.store(output_ptr + (original_index), temp4, input_mask)
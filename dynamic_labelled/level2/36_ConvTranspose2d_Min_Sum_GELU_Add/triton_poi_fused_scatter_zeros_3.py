...
@triton.jit
def triton_poi_fused_scatter_zeros_3poi_fused_scatter_zeros_3(input_ptr0, input_ptr1, input_ptr2, output_ptr0, kernel_size0, kernel_size1, kernel_size2, num_elements, XBLOCK: tl.constexpr):
    ...
    linear_index_mod = index % kernel_size1
    ...
    store_index = linear_index_mod + 4 * value0 * kernel_size2 * kernel_size2 + 64 * kernel_index2 * kernel_size2 * kernel_size2
    tl.store(output_ptr0 + store_index, result, mask)
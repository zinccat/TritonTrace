...
@triton.jit
def triton_red_fused_mul_sum_0(input_ptr0, input_ptr1, output_ptr0, num_elements_x, num_elements_r, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    num_elements_x = 16
    ...
    for r_offset in range(0, num_elements_r, RBLOCK):
        ...
        temp_broadcast = tl.broadcast_to(temp_product1, [XBLOCK, RBLOCK])

...
@triton.jit
def triton_red_fused_neg_sum_2red_fused_neg_sum_2(in_ptr0, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    xnumel = 512
    ...
    tl.store(out_ptr0 + (x_indices_0), summed_negatives, x_mask)
    tl.store(out_ptr1 + (x_indices_0), summed_originals, x_mask)
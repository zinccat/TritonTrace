...
def triton_poi_fused_mul_sum_1(input_ptr, output_ptr, num_elements, XBLOCK: tl.constexpr):
    ...
    input_value_3 = tl.load(input_ptr + (2 + 5 * base_indices), mask, eviction_policy='evict_last')
    input_value_4 = tl.load(input_ptr + (3 + 5 * base_indices), mask, eviction_policy='evict_last')

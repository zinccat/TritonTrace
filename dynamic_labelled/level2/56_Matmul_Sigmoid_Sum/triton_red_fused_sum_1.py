...
def triton_red_fused_sum_1red_fused_sum_1(in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    ...
    for r_offset in range(0, rnumel, RBLOCK):
        ...
        loaded_values = tl.load(in_ptr0 + (x_indices_expanded + 20 * r_indices_expanded), r_mask & x_mask, eviction_policy='evict_first', other=0.0)
    ...
    tl.store(out_ptr0 + (x_indices_expanded), reduced_sum, x_mask)
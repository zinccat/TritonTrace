...
@triton.jit
def triton_red_fused_convolution_backward_2(
    ...
    for reduction_offset in range(0, reduction_num_elements, RBLOCK):
        ...
        temp_load = tl.load(
            input_ptr + (
                ...
                (-2) * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                4 * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                kernel_size_w * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                kernel_size_w * kernel_size_w * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                (-32) * kernel_size_w * kernel_size_w * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                (-4) * kernel_size_w * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                64 * kernel_size_h * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                128 * kernel_size_w * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                (-64) * kernel_size_h * kernel_size_w * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 
                ...
                16 * kernel_size_h * kernel_size_w * kernel_size_w * (((reduction_linear_index + input_block * (
                    triton_helpers.div_floor_integer(
                        20 + (-8 * kernel_size_d) + (-2 * kernel_size_d * kernel_size_w * kernel_size_w) + 
                        4 * kernel_size_d * kernel_size_h + 8 * kernel_size_d * kernel_size_w + 
                        kernel_size_d * kernel_size_h * kernel_size_w * kernel_size_w + 

...
def triton_per_fused_convolution_backward_5(
    ...
    loaded_values = tl.load(input_ptr + (input_col_indices + 32 * output_row_indices), output_mask & input_mask, other=0.0)

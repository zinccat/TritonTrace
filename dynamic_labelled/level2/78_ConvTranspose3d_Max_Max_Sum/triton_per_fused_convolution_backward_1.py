...
def triton_per_fused_convolution_backward_1(in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK: tl.constexpr):
    ...
    loaded_data = tl.load(in_ptr0 + (reduction_indices + 21 * input_indices), reduction_mask & input_mask, other=0.0)

    # Broadcast loaded data to match the shape for reduction

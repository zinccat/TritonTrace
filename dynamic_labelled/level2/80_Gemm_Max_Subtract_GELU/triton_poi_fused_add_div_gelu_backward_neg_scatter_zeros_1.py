...
@triton.jit
def triton_poi_fused_add_div_gelu_backward_neg_scatter_zeros_1poi_fused_add_div_gelu_backward_neg_scatter_zeros_1(
    ...
    tl.device_assert(((0 <= input_values0) & (input_values0 < 1024)) | ~mask, "index out of bounds: 0 <= input_values0 < 1024")

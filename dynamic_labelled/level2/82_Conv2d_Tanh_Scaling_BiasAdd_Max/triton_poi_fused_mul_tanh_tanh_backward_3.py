...
@triton.jit
def triton_poi_fused_mul_tanh_tanh_backward_3poi_fused_mul_tanh_tanh_backward_3(in_out_ptr0, in_ptr0, xnumel, XBLOCK: tl.constexpr):
    ...
    updated_grad_output = scaled_grad_output * one_minus_tanh_squared
    tl.store(in_out_ptr0 + (x0), updated_grad_output, xmask)
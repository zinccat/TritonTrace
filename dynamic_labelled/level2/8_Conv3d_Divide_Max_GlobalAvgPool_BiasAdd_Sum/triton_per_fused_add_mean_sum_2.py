...
@triton.jit
def triton_per_fused_add_mean_sum_2per_fused_add_mean_sum_2(
    input_ptr0, input_ptr1, output_ptr0, kernel_size0, kernel_size1, num_elements_x, num_elements_r, XBLOCK: tl.constexpr
):

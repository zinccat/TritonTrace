...
@triton.jit
def triton_red_fused_sum_2(input_ptr, output_ptr, kernel_size_0, kernel_size_1, kernel_size_2, input_num_elements, reduction_num_elements, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    ...
    for reduction_offset in range(0, reduction_num_elements, RBLOCK):
        ...
        temp_index_0 = reduction_index_2 + input_index // 16 * (
            triton_helpers.div_floor_integer(
                ...
                (-4 * kernel_size_0 * kernel_size_1 * kernel_size_2), 21
            )
        )
        ...
        temp_index_3 = tl.load(
            input_ptr + (
                (-128) * (
                    ((reduction_index_2 + input_index // 16 * (
                        triton_helpers.div_floor_integer(
                            20 + (-8 * kernel_size_0) + (-2 * kernel_size_0 * kernel_size_2 * kernel_size_2) +
                            4 * kernel_size_0 * kernel_size_1 + 8 * kernel_size_0 * kernel_size_2 +
                            kernel_size_0 * kernel_size_1 * kernel_size_2 * kernel_size_2 +
                         ...
                         kernel_size_1 * kernel_size_2 * kernel_size_2 + (-4) * kernel_size_1 * kernel_size_2)
                    ) % kernel_size_0
                )
                + (-8) * input_index_0
                + (-2) * (
                ...
                + 4 * (
                    ...
                    ) // (4 + kernel_size_2 * kernel_size_2 + (-4) * kernel_size_2)
                    ) % ((-2) + kernel_size_1))
                    + kernel_size_2 * (
                        ((reduction_index_2 + input_index // 16 * (
                            triton_helpers.div_floor_integer(
                    ...
                    + kernel_size_2 * kernel_size_2 * (
                        ...
                        + (-2) * input_index_0 * kernel_size_2 * kernel_size_2
                        + 4 * kernel_size_1 * input_index_0
                        + 8 * kernel_size_2 * input_index_0
                        + 64 * kernel_size_1 * (
                            ((reduction_index_2 + input_index // 16 * (
                                triton_helpers.div_floor_integer(
                                    20 + (-8 * kernel_size_0) + (-2 * kernel_size_0 * kernel_size_2 * kernel_size_2) +
                        ...
                        + kernel_size_1 * input_index_0 * kernel_size_2 * kernel_size_2
                        ...
                        + (-4) * kernel_size_1 * kernel_size_2 * input_index_0
            ...
            ), reduction_mask & temp_index_2 & input_mask, eviction_policy='evict_last', other=0.0
        )

        temp_buffer_4 = tl.broadcast_to(temp_index_3, [XBLOCK, RBLOCK])
        temp_buffer_6 = temp_buffer + temp_buffer_4
        temp_buffer = tl.where(reduction_mask & input_mask, temp_buffer_6, temp_buffer)

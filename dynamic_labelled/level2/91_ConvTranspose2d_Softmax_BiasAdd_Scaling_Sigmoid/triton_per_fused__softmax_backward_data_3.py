...
@triton.jit
def triton_per_fused__softmax_backward_data_3(in_ptr0, out_ptr0, kernel_size0, kernel_size1, input_num_elements, reduction_num_elements, XBLOCK: tl.constexpr):
    ...
    tl.store(out_ptr0 + (flat_input_index), summed_values, input_mask)
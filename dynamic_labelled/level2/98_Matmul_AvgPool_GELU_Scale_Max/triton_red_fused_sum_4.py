...
@triton.jit
def triton_red_fused_sum_4red_fused_sum_4(in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    xnumel = 256
    ...
    for r_offset in range(0, rnumel, RBLOCK):
        ...
        loaded_values = tl.load(in_ptr0 + (x_indices_0 + 256 * r_indices_1), r_mask & x_mask, eviction_policy='evict_first', other=0.0)

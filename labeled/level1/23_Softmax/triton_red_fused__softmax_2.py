...
@triton.jit
def triton_red_fused__softmax_2(in_ptr0, in_ptr1, out_ptr0, xnumel, rnumel, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    xnumel = 32
    rnumel = 8192
    ...
    for r_offset in range(0, rnumel, RBLOCK):
        ...
        adjusted_values = input_values_0 - input_values_1

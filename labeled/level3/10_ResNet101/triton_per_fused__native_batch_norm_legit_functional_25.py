...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_25(
    ...
    updated_running_mean = scaled_mean + running_mean * running_mean_factor
    ...
    updated_running_var = scaled_variance + running_var * running_mean_factor

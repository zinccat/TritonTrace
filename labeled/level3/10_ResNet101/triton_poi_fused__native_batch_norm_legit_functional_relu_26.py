...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_26poi_fused__native_batch_norm_legit_functional_relu_26(input_ptr_mean, input_ptr_var, input_ptr_scale, input_ptr_shift, input_ptr_input, output_ptr, num_elements, BLOCK_SIZE : tl.constexpr):
    ...
    epsilon = 1e-05
    adjusted_variance = input_var / variance_inverse

...
@triton.jit
def triton_poi_fused_convolution_relu_15poi_fused_convolution_relu_15(in_out_ptr0, in_ptr0, xnumel, XBLOCK: tl.constexpr):
    ...
    weight_value = tl.load(in_ptr0 + (x0), None, eviction_policy='evict_last')

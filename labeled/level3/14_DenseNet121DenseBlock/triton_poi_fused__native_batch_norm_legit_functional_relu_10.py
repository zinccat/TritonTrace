...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_10poi_fused__native_batch_norm_legit_functional_relu_10(
    ...
    channel_indices = (block_indices // 50176) % 96

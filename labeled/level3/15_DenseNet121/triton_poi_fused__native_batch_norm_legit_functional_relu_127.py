...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_127poi_fused__native_batch_norm_legit_functional_relu_127(
    ...
    channel_index = (block_indices // 196) % 768
    ...
    scaled_shifted_input = scaled_input * scale
    output_data = scaled_shifted_input + shift

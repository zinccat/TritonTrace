...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_137poi_fused__native_batch_norm_legit_functional_relu_137(
    ...
    num_elements = 1818880
    block_offset = tl.program_id(0) * BLOCK_SIZE
    block_indices = block_offset + tl.arange(0, BLOCK_SIZE)[:]
    mask = block_indices < num_elements
    input_indices = block_indices
    channel_indices = (block_indices // 196) % 928

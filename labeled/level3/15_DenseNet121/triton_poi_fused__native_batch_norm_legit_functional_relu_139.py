...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_139poi_fused__native_batch_norm_legit_functional_relu_139(
    ...
    channel_indices = (block_indices // 196) % 960

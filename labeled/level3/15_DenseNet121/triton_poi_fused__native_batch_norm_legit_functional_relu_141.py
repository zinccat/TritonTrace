...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_141poi_fused__native_batch_norm_legit_functional_relu_141(
    ...
    channel_indices = (block_indices // 196) % 992

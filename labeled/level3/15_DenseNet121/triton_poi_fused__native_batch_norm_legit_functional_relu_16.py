...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_16poi_fused__native_batch_norm_legit_functional_relu_16(
    ...
    channel_indices = (block_indices // 3136) % 128

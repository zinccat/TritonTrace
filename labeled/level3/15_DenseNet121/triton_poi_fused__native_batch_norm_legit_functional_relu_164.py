...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_164poi_fused__native_batch_norm_legit_functional_relu_164(
    ...
    channel_indices = (block_indices // 49) % 672

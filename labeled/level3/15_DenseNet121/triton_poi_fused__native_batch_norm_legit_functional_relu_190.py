...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_190poi_fused__native_batch_norm_legit_functional_relu_190(
    ...
    channel_indices = (block_indices // 49) % 960

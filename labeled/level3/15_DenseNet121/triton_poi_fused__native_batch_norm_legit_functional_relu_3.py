...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_3poi_fused__native_batch_norm_legit_functional_relu_3(
    ...
    channel_indices = (block_indices // 12544) % 64

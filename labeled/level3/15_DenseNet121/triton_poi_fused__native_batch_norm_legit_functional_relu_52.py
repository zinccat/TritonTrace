...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_52poi_fused__native_batch_norm_legit_functional_relu_52(
    ...
    batch_indices = (block_indices // 784) % 320

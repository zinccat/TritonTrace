...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_116(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_values = tl.load(
            input_ptr_mean + (r_channel + 196 * x_indices_flat + 119168 * r_feature_map), 
            r_mask & x_mask, 
    ...
    mean_correction = final_var * scale_factor * momentum
    adjusted_var = mean_correction + input_var * 0.9

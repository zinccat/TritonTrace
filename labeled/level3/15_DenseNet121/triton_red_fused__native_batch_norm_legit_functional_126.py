...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_126(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_values = tl.load(
            input_ptr_input + (r_channel + 196 * x_indices_flat + 150528 * r_feature_map), 
            r_mask & x_mask, 
    ...
    inv_std = tl.extra.cuda.libdevice.rsqrt(variance_broadcasted / epsilon + variance_epsilon)
    ...
    updated_variance = variance_scaled + input_var * 0.9

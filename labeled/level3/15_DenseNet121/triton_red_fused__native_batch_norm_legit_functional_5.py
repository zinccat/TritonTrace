...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_5red_fused__native_batch_norm_legit_functional_5(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (56 * (((r_flat_index + 7840 * x_height) // 56) % 56) + 3136 * x_channel + 200704 * ((r_flat_index + 7840 * x_height) // 3136) + (r_flat_index % 56)),
            r_mask & x_mask,

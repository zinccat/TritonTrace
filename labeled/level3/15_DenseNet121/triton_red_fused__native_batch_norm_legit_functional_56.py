...
def triton_red_fused__native_batch_norm_legit_functional_56red_fused__native_batch_norm_legit_functional_56(
    ...
    for r_offset in range(0, num_elements_r, RBLOCK):
        ...
        r_col = (r_indices % 784)
        r_row = r_indices // 784
        input_data = tl.load(input_ptr_mean + (r_col + 784 * x_indices_flat + 301056 * r_row), r_mask & x_mask, eviction_policy='evict_first', other=0.0)
    ...
    num_batches = 7840.0
    epsilon = 1e-05
    variance_epsilon = variance_broadcast / num_batches + epsilon

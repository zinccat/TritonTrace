...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_281(
    ...
    x0 = xindex
    mean_value = tl.load(input_mean_ptr + (row_index + 49 * x0 + 68992 * channel_index), rmask, other=0.0)
    ...
    momentum = 0.1
    adjusted_mean = mean_broadcast * momentum + running_mean * 0.9

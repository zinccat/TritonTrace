...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_297(
    ...
    x0 = xindex
    mean_value = tl.load(input_mean_ptr + (row_index + 49 * x0 + 81536 * channel_index), rmask, other=0.0)
    ...
    running_mean_update = running_mean * 0.9 + adjusted_mean
    variance_scale = 1.0020449897750512
    adjusted_variance = variance_sum * variance_scale * momentum
    running_var_update = running_var * 0.9 + adjusted_variance

...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_301(
    ...
    x0 = xindex
    mean_value = tl.load(input_mean_ptr + (row_index + 49 * x0 + 84672 * channel_index), rmask, other=0.0)
    ...
    momentum = 0.1
    adjusted_mean = mean_adjusted * momentum + running_mean * 0.9
    adjusted_var = variance * 1.0020449897750512 * momentum + running_var * 0.9
    ...
    tl.store(output_scale_ptr + (x0), mean_adjusted, None)

...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_303(
    ...
    input_mean = tl.load(input_mean_ptr + (row_index + 49 * x0 + 86240 * channel_index), rmask, other=0.0)
    ...
    running_var_update = running_var + input_var * 0.9

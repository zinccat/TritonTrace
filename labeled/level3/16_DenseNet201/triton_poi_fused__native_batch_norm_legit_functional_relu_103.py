...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_103poi_fused__native_batch_norm_legit_functional_relu_103(
    ...
    channel_indices = (block_indices // 196) % 416

...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_149poi_fused__native_batch_norm_legit_functional_relu_149(
    ...
    channel_index = (block_indices // 196) % 736

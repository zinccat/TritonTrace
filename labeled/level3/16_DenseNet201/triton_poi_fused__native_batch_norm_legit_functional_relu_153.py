...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_153poi_fused__native_batch_norm_legit_functional_relu_153(
    ...
    num_elements = 1568000
    block_offset = tl.program_id(0) * BLOCK_SIZE
    block_indices = block_offset + tl.arange(0, BLOCK_SIZE)[:]
    valid_mask = block_indices < num_elements
    flat_indices = block_indices
    channel_indices = (block_indices // 196) % 800
    ...
    variance_adjusted = adjusted_variance + epsilon

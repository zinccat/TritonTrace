...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_163poi_fused__native_batch_norm_legit_functional_relu_163(
    ...
    num_elements = 1881600
    block_offset = tl.program_id(0) * BLOCK_SIZE
    block_indices = block_offset + tl.arange(0, BLOCK_SIZE)[:]
    valid_mask = block_indices < num_elements
    global_index = block_indices
    channel_index = (block_indices // 196) % 960

...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_179poi_fused__native_batch_norm_legit_functional_relu_179(
    ...
    num_elements = 2383360
    block_offset = tl.program_id(0) * BLOCK_SIZE
    block_indices = block_offset + tl.arange(0, BLOCK_SIZE)[:]
    valid_mask = block_indices < num_elements
    linear_index = block_indices
    channel_index = (block_indices // 196) % 1216

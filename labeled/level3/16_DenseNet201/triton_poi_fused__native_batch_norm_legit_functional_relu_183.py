...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_183poi_fused__native_batch_norm_legit_functional_relu_183(
    ...
    channel_indices = (block_indices // 196) % 1280

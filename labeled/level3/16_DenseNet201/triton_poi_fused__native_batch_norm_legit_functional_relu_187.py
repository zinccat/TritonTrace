...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_187poi_fused__native_batch_norm_legit_functional_relu_187(
    ...
    num_elements = 2634240
    block_offset = tl.program_id(0) * BLOCK_SIZE
    block_indices = block_offset + tl.arange(0, BLOCK_SIZE)[:]
    valid_mask = block_indices < num_elements
    flat_index = block_indices
    channel_index = (block_indices // 196) % 1344

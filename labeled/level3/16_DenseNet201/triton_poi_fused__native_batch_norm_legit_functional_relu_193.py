...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_193poi_fused__native_batch_norm_legit_functional_relu_193(
    ...
    num_elements = 2822400
    block_offset = tl.program_id(0) * BLOCK_SIZE
    block_indices = block_offset + tl.arange(0, BLOCK_SIZE)[:]
    valid_mask = block_indices < num_elements
    global_indices = block_indices
    channel_indices = (block_indices // 196) % 1440

...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_23poi_fused__native_batch_norm_legit_functional_relu_23(
    ...
    channel_indices = (block_indices // 3136) % 192

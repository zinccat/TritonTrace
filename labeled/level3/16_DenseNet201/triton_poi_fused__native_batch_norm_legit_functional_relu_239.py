...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_239poi_fused__native_batch_norm_legit_functional_relu_239(
    ...
    channel_indices = (block_indices // 49) % 1024

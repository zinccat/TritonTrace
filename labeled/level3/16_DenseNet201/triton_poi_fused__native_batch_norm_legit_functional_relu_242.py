...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_242poi_fused__native_batch_norm_legit_functional_relu_242(
    ...
    channel_indices = (block_indices // 49) % 1056

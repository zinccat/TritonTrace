...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_286poi_fused__native_batch_norm_legit_functional_relu_286(
    ...
    channel_indices = (block_indices // 49) % 1472

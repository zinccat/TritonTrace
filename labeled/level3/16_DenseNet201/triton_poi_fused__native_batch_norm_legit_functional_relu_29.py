...
def triton_poi_fused__native_batch_norm_legit_functional_relu_29poi_fused__native_batch_norm_legit_functional_relu_29(
    ...
    channel_indices = (block_indices // 3136) % 256
    ...
    inv_std_dev = var_data / variance_scale + epsilon
    ...
    relu_output = triton_helpers.maximum(relu_output, scaled_and_shifted_data)

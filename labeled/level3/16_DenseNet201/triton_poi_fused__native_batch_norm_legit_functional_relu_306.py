...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_306poi_fused__native_batch_norm_legit_functional_relu_306(
    ...
    channel_indices = (block_indices // 49) % 1792

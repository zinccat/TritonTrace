...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_310poi_fused__native_batch_norm_legit_functional_relu_310(
    ...
    channel_indices = (block_indices // 49) % 1856

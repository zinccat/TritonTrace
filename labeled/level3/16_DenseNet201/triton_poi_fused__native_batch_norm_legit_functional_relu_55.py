...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_55poi_fused__native_batch_norm_legit_functional_relu_55(
    ...
    batch_index = (block_indices // 784) % 352

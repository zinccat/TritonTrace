...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_91poi_fused__native_batch_norm_legit_functional_relu_91(
    ...
    channel_indices = (block_indices // 196) % 288

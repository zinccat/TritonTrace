...
def triton_red_fused__native_batch_norm_legit_functional_142(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_values = tl.load(
            input_ptr_input + (r_channel + 196 * x_indices_flat + 125440 * r_feature_map), 
            r_mask & x_mask, 
    ...
    epsilon = 1e-05
    variance_adjusted = final_var / num_reduction_elements
    ...
    momentum_complement = 0.9
    input_mean_scaled = input_mean * momentum_complement
    ...
    input_var_scaled = input_var * momentum_complement

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_154red_fused__native_batch_norm_legit_functional_154(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_values = tl.load(
            input_ptr_input + (r_channel + 196 * x_indices_flat + 163072 * r_feature_map), 
            r_mask & x_mask, 
    ...
    updated_var = variance_scaled + input_var * (1 - momentum)

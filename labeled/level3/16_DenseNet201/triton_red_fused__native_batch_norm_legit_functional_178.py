...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_178(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr_mean + (r_channel + 196 * x_indices_flat + 238336 * r_feature_map), 
            r_mask & x_mask, 
    ...
    variance_scaled = variance_broadcast * 1.0005104645227156

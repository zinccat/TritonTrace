...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_188red_fused__native_batch_norm_legit_functional_188(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr_mean + (r_channel + 196 * x_indices_flat + 269696 * r_feature_map), 
            r_mask & x_mask, 
    ...
    updated_var = mean_correction + input_var * 0.9

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_194red_fused__native_batch_norm_legit_functional_194(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr_input + (r_channel + 196 * x_indices_flat + 288512 * r_sample), 
            r_mask & x_mask, 

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_196red_fused__native_batch_norm_legit_functional_196(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_values = tl.load(
            input_ptr_mean + (r_channel + 196 * x_indices_flat + 294784 * r_feature_map), 
            r_mask & x_mask, 
    ...
    input_values_input = tl.load(input_ptr_input + (x_indices_flat), x_mask, eviction_policy='evict_last')
    ...
    momentum_factor = 0.9
    running_mean_momentum = input_values_var * momentum_factor
    ...
    updated_var = variance_adjusted_scaled + running_mean_momentum

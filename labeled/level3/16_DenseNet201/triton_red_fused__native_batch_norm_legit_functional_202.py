...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_202(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr_mean + (r_channel + 196 * x_indices_flat + 313600 * r_feature_map), 
            r_mask & x_mask, 
    ...
    epsilon = 1e-05
    inv_std = tl.extra.cuda.libdevice.rsqrt(variance_broadcast / 1960.0 + epsilon)
    momentum = 0.1

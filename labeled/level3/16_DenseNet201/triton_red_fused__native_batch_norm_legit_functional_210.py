...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_210red_fused__native_batch_norm_legit_functional_210(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_values = tl.load(
            input_ptr_input + (r_channel + 196 * x_indices_flat + 338688 * r_feature_map), 
            r_mask & x_mask, 
    ...
    epsilon = 1e-05
    inv_std = (final_var_expanded / num_reduction_elements + epsilon).rsqrt()
    ...
    variance_scaled = final_var_expanded * variance_scale * momentum
    updated_var = variance_scaled + input_var * 0.9

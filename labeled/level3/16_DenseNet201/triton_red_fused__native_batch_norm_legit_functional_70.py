...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_70red_fused__native_batch_norm_legit_functional_70(
    ...
    momentum_var = 0.9
    input_var_scaled = input_var * momentum_var
    adjusted_var = variance_broadcast * (1 - momentum_var) + input_var_scaled
    
    scale_factor = 1.0005104645227156
    variance_scaled = variance_broadcast * scale_factor * momentum
    adjusted_variance = variance_scaled + input_var_scaled

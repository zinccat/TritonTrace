...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_99red_fused__native_batch_norm_legit_functional_99(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr_mean + (r_channel + 196 * x_indices_flat + 75264 * r_feature_map), 
            r_mask & x_mask, 
    ...
    tl.store(output_ptr_scaled + (x_indices_flat), normalized_input, x_mask)
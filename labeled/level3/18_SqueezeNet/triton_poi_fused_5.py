...
@triton.jit
def triton_poi_fused_5poi_fused_5(input_ptr, output_ptr, num_elements_y, num_elements_x, YBLOCK: tl.constexpr, XBLOCK: tl.constexpr):
    num_elements_y = 3
    ...
    tl.store(output_ptr + (y_indices_adjusted + 3 * x_indices_adjusted), temp_data, x_mask & y_mask)
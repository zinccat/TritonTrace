...
@triton.jit
def triton_poi_fused_cat_13poi_fused_cat_13(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK: tl.constexpr):
    xnumel = 746496
    ...
    threshold = tl.full([1], 128, tl.int64)
    is_below_threshold = x_mod_256 < threshold
    ...
    is_above_threshold = x_mod_256 >= threshold

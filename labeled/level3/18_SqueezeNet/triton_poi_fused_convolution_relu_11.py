...
@triton.jit
def triton_poi_fused_convolution_relu_11poi_fused_convolution_relu_11(output_ptr, input_ptr, num_elements, BLOCK_SIZE : tl.constexpr):
    num_elements = 93312
    ...
    relu_values = triton_helpers.maximum(zero_tensor, accumulated_values)

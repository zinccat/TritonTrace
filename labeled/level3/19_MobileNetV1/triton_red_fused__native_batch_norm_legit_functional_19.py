...
def triton_red_fused__native_batch_norm_legit_functional_19(
    ...
    input_block_row = input_indices // 128
    input_block_col = (input_indices % 128)
    ...
    tl.store(output_mean_ptr + (input_flat_indices), final_mean, input_mask)
    tl.store(output_var_ptr + (input_flat_indices), final_m2, input_mask)
    tl.store(output_count_ptr + (input_flat_indices), final_weight, input_mask)
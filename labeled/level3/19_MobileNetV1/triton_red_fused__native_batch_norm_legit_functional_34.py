...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_34red_fused__native_batch_norm_legit_functional_34(
    ...
    for r_offset in range(0, rnumel, RBLOCK):
        ...
        loaded_values = tl.load(
            input_ptr + (x0 + 1024 * ((r2 + 123 * x1) % 490)), 
            r_mask & index_mask, 
        ...
        broadcast_ones = tl.where(index_mask, 1.0, one_values)

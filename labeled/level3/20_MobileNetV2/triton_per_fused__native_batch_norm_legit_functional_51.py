...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_51(
    ...
    normalized_var = var_broadcast / 490.0
    epsilon = 1e-05
    ...
    updated_running_var = scaled_mean + running_var * running_var_factor
    ...
    tl.store(output_x_ptr + (x0), mean_broadcast, xmask)
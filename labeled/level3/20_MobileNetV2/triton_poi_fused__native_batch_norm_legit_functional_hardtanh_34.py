...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_hardtanh_34poi_fused__native_batch_norm_legit_functional_hardtanh_34(input_ptr0, input_ptr1, input_ptr2, input_ptr3, input_ptr4, output_ptr0, num_elements, BLOCK_SIZE : tl.constexpr):
    ...
    clamped_data = triton_helpers.maximum(shifted_data, clamped_min)
    clamped_data = triton_helpers.minimum(clamped_data, clamped_max)

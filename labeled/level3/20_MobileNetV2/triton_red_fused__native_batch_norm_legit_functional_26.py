...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_26red_fused__native_batch_norm_legit_functional_26(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        temp_values = tl.load(
            input_ptr + (x_within_channel + 144 * ((temp_index % 7840))),

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_50red_fused__native_batch_norm_legit_functional_50(
    ...
    x_channel = x_indices // 576
    x_within_channel = x_indices % 576

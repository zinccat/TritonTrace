...
def triton_red_fused__native_batch_norm_legit_functional_53(
    ...
    input_channel = input_indices // 160
    input_position = input_indices % 160
    ...
    for reduction_offset in range(0, reduction_num_elements, RBLOCK):
        ...
        temp_input = tl.load(
            input_ptr + (input_position + 160 * ((temp_index % 490))),
        ...
        temp_input_broadcast = tl.broadcast_to(temp_input, [XBLOCK, RBLOCK])
        ...
        temp_mean_next, temp_m2_next, temp_weight_next = triton_helpers.welford_combine(
            ...
            temp_input_broadcast, temp_zero_broadcast, temp_one_broadcast
        )

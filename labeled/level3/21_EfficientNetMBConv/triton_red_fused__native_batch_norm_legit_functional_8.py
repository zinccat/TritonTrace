...
def triton_red_fused__native_batch_norm_legit_functional_8red_fused__native_batch_norm_legit_functional_8(
    input_ptr, output_ptr_mean, output_ptr_var, output_ptr_count, total_elements, reduction_elements, 
    XBLOCK: tl.constexpr, RBLOCK: tl.constexpr
):
    reduction_elements = 392
    ...
    for reduction_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (x_col + 192 * reduction_index + 75264 * x_row), 
            reduction_mask, 
        ...
        mean_next, m2_next, weight_next = triton_helpers.welford_reduce(
            broadcasted_data, mean_accumulator, m2_accumulator, weight_accumulator, reduction_offset == 0
        )

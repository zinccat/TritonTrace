...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_add_65poi_fused__native_batch_norm_legit_functional_add_65(
    ...
    normalized_variance = var_data / 490.0 + variance_epsilon

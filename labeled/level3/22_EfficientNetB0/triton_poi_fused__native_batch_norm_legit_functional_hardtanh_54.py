...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_hardtanh_54poi_fused__native_batch_norm_legit_functional_hardtanh_54(input_ptr_mean, input_ptr_var, input_ptr_scale, input_ptr_shift, input_ptr_out, output_ptr, total_elements, BLOCK_SIZE : tl.constexpr):
    total_elements = 1317120
    ...
    input_out = tl.load(input_ptr_out + (channel_indices), valid_mask, eviction_policy='evict_last')

...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_hardtanh_64poi_fused__native_batch_norm_legit_functional_hardtanh_64(input_ptr0, input_ptr1, input_ptr2, input_ptr3, input_ptr4, output_ptr0, xnumel, XBLOCK: tl.constexpr):
    xnumel = 564480

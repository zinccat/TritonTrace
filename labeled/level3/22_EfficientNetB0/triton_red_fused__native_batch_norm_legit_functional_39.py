...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_39red_fused__native_batch_norm_legit_functional_39(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        temp_load = tl.load(
            input_ptr + (x_within_channel + 240 * ((temp_index % 1960))),
        ...
        temp_broadcast_one = tl.broadcast_to(temp_one_broadcast, [XBLOCK, RBLOCK])

...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_47(
    ...
    r1 = r_index
    x0 = x_index
    input_mean = tl.load(input_mean_ptr + (x0 + 112 * r1), r_mask & x_mask, other=0.0)
    input_var = tl.load(input_var_ptr + (x0 + 112 * r1), r_mask & x_mask, other=0.0)
    input_count = tl.load(input_count_ptr + (x0 + 112 * r1), r_mask & x_mask, other=0.0)
    ...
    scale_factor = 1.0004446420631392

...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_33poi_fused__native_batch_norm_legit_functional_33(
    ...
    variance_normalized = variance / 9000.0
    epsilon = 1e-05

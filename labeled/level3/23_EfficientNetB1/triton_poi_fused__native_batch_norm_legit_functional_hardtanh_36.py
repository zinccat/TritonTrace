...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_hardtanh_36poi_fused__native_batch_norm_legit_functional_hardtanh_36(
    ...
    scaled_and_shifted = scaled_input * input_scale
    final_output = scaled_and_shifted + input_shift

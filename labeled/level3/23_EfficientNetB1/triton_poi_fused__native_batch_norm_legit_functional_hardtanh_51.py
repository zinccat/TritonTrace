...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_hardtanh_51poi_fused__native_batch_norm_legit_functional_hardtanh_51(
    ...
    final_output = shifted_input + output_ptr_base

...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_5poi_fused__native_batch_norm_legit_functional_relu_5(
    ...
    input_shift = tl.load(input_ptr_shift + (element_index), None, eviction_policy='evict_last')

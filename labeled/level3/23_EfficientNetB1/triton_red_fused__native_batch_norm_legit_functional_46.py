...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_46red_fused__native_batch_norm_legit_functional_46(
    ...
    x_channel = (x_indices % 112)
    x_batch = x_indices // 112
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (x_channel + 112 * r_reduction_index + 14000 * x_batch), 
            r_mask & x_mask, 

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_55red_fused__native_batch_norm_legit_functional_55(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (x_channel + 192 * r_reduction_index + 24576 * x_batch), 
            r_mask & x_mask, 

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_58red_fused__native_batch_norm_legit_functional_58(
    ...
    x_channel_index = (x_indices % 1152)
    x_batch_index = x_indices // 1152
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (x_channel_index + 1152 * r_flat_index + 147456 * x_batch_index), 
            r_mask & x_mask, 

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_61red_fused__native_batch_norm_legit_functional_61(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (x_channel + 320 * r_reduction_index + 40960 * x_batch), 
            r_mask & x_mask, 

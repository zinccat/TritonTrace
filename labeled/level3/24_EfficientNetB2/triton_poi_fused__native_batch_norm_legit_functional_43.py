...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_43poi_fused__native_batch_norm_legit_functional_43(input_ptr_mean, input_ptr_var, input_ptr_running_mean, output_ptr_normalized, output_ptr_running_mean, output_ptr_running_var, num_elements, BLOCK_SIZE : tl.constexpr):
    num_elements = 384
    ...
    variance = tl.load(input_ptr_mean + (384 + indices), valid_mask)

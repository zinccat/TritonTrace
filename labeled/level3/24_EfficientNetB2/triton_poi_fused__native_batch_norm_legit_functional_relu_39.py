...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_39poi_fused__native_batch_norm_legit_functional_relu_39(
    ...
    var_value_2 = tl.load(input_ptr_var + (1728 + x0), xmask, eviction_policy='evict_last')
    ...
    epsilon = 2.0
    var_sum_div_epsilon = var_sum / epsilon
    epsilon_stable = 1e-05
    var_sum_div_epsilon_stable = var_sum_div_epsilon + epsilon_stable
    inv_sqrt_var = tl.extra.cuda.libdevice.rsqrt(var_sum_div_epsilon_stable)

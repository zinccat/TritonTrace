...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_15red_fused__native_batch_norm_legit_functional_15(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (x_channel + 128 * r_flat_index + 16384 * x_batch), 
            r_mask & x_mask, 

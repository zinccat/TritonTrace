...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_21red_fused__native_batch_norm_legit_functional_21(
    ...
    for r_offset in range(0, reduction_elements, RBLOCK):
        ...
        input_data = tl.load(
            input_ptr + (x_channel + 256 * r_flat_index + 32768 * x_sample), 
            r_mask & x_mask, 
    ...
    tl.store(output_ptr_weight + (x_flat_index), weight_result, x_mask)
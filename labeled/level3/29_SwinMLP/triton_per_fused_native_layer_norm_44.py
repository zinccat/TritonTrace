...
@triton.jit
def triton_per_fused_native_layer_norm_44per_fused_native_layer_norm_44(in_out_ptr0, in_ptr0, out_ptr0, xnumel, rnumel):
    ...
    r1 = r_index
    x0 = x_index
    input_values = tl.load(in_ptr0 + (r1 + 768 * x0), r_mask, other=0.0)

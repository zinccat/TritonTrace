...
@triton.jit
def triton_poi_fused_cat_39poi_fused_cat_39(in_ptr0, out_ptr0, xnumel, XBLOCK: tl.constexpr):
    xnumel = 188160
    ...
    input_offset = element_within_group + 768 * group_index_within_batch + 10752 * batch_index

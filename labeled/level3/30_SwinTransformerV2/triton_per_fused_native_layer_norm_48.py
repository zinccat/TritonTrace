...
@triton.jit
def triton_per_fused_native_layer_norm_48per_fused_native_layer_norm_48(
    ...
    # Load input data
    input_data = tl.load(in_ptr0 + (r1 + 384 * x0), r_mask, other=0.0)
    ...
    num_elements = tl.full([1], 384, tl.int32).to(tl.float32)
    ...
    tl.store(out_ptr1 + (r1 + 384 * x0), scaled_output, r_mask)

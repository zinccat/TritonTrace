...
@triton.jit
def triton_poi_fused_cat_46poi_fused_cat_46(in_ptr0, out_ptr0, xnumel, XBLOCK: tl.constexpr):
    xnumel = 376320
    ...
    input_data = tl.load(in_ptr0 + (192 + element_index + 384 * channel_index + 10752 * batch_index), valid_mask)

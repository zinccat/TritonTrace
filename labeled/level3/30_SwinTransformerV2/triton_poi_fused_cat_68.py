...
@triton.jit
def triton_poi_fused_cat_68poi_fused_cat_68(in_ptr0, out_ptr0, xnumel, XBLOCK: tl.constexpr):
    xnumel = 188160
    ...
    block_column = index_within_block // 384
    
    input_offset = 5376 + block_offset + 768 * block_row + 10752 * block_depth
    output_offset = block_offset + 1536 * block_column

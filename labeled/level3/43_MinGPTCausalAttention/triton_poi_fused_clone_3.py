...
def triton_poi_fused_clone_3poi_fused_clone_3(input_ptr0, input_ptr1, output_ptr0, num_elements, BLOCK_SIZE : tl.constexpr):
    ...
    tmp0 = tl.load(input_ptr0 + (1536 + index_mod_96 + 96*index_div_49152_mod_8 + 2304*index_div_96_mod_512 + 1179648*index_div_393216), None)
    tmp1 = tl.load(input_ptr1 + (1536 + index_mod_96 + 96*index_div_49152_mod_8), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    
    tl.store(output_ptr0 + (flat_index), tmp2, None)
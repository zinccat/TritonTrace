...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_7(
    input_mean_ptr, input_var_ptr, input_x_ptr, running_mean_ptr, running_var_ptr, 
    output_mean_ptr, output_var_ptr, output_x_ptr, output_running_mean_ptr, 
    ...
    rsqrt_denom = 65536.0
    epsilon = 1e-05
    adjusted_var = var_reshaped / rsqrt_denom + epsilon
    ...
    scale_factor = 1.0000152590218967
    scaled_var = var_reshaped * scale_factor * momentum

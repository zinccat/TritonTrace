...
def triton_red_fused_sum_4red_fused_sum_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, rnumel, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr):
    ...
    for r_offset in range(0, rnumel, RBLOCK):
        ...
        temp0 = tl.load(in_ptr0 + (x_mod_32 + 32 * r_index_flat + 3200 * x_div_32), r_mask & x_mask, eviction_policy='evict_first', other=0.0)
    ...
    tl.store(out_ptr0 + (x_full_index), temp_final_sum, x_mask)
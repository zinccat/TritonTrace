...
def triton_poi_fused_clone_1poi_fused_clone_1(input_ptr0, input_ptr1, output_ptr0, num_elements, BLOCK_SIZE : tl.constexpr):
    ...
    tmp0 = tl.load(input_ptr0 + (index_mod_64 + 64 * index_div_65536_mod_12 + 2304 * index_div_64_mod_1024 + 2359296 * index_div_786432), None)
    tmp1 = tl.load(input_ptr1 + (index_mod_64 + 64 * index_div_65536_mod_12), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1

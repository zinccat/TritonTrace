...
@triton.jit
def triton_poi_fused_4poi_fused_4(input_ptr, output_ptr, total_y_elements, total_x_elements, YBLOCK: tl.constexpr, XBLOCK: tl.constexpr):
    total_y_elements = 147456
    total_x_elements = 9
    ...
    tl.store(output_ptr + (y_mod + 384 * x_coord + 3456 * y_div), temp_data, x_mask & y_mask)
...
@triton.jit
def triton_poi_fused_max_pool2d_with_indices_7poi_fused_max_pool2d_with_indices_7(input_ptr, output_ptr_value, output_ptr_index, num_elements, BLOCK_SIZE : tl.constexpr):
    num_elements = 699840
    ...
    # Load input values
    input_val_0 = tl.load(input_ptr + (x + 192*y + 10560*z + 290400*batch), mask)
    input_val_1 = tl.load(input_ptr + (96 + x + 192*y + 10560*z + 290400*batch), mask)
    input_val_2 = tl.load(input_ptr + (192 + x + 192*y + 10560*z + 290400*batch), mask)
    input_val_3 = tl.load(input_ptr + (5280 + x + 192*y + 10560*z + 290400*batch), mask)
    input_val_4 = tl.load(input_ptr + (5376 + x + 192*y + 10560*z + 290400*batch), mask)
    input_val_5 = tl.load(input_ptr + (5472 + x + 192*y + 10560*z + 290400*batch), mask)
    input_val_6 = tl.load(input_ptr + (10560 + x + 192*y + 10560*z + 290400*batch), mask)
    input_val_7 = tl.load(input_ptr + (10656 + x + 192*y + 10560*z + 290400*batch), mask)
    input_val_8 = tl.load(input_ptr + (10752 + x + 192*y + 10560*z + 290400*batch), mask)
    ...
    # Store results
    tl.store(output_ptr_value + (linear_index), max_val_8, mask)

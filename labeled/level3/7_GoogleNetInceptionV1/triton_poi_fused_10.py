...
@triton.jit
def triton_poi_fused_10poi_fused_10(input_ptr, output_ptr, num_elements_y, num_elements_x, YBLOCK: tl.constexpr, XBLOCK: tl.constexpr):
    num_elements_y = 1536
    num_elements_x = 25
    ...
    y_mod_24 = y_indices % 24
    y_div_24 = y_indices // 24
    temp_data = tl.load(input_ptr + (x_indices_adjusted + 25 * y_indices_adjusted), x_mask & y_mask, eviction_policy='evict_last')
    tl.store(output_ptr + (y_mod_24 + 24 * x_indices_adjusted + 600 * y_div_24), temp_data, x_mask & y_mask)
...
@triton.jit
def triton_poi_fused_14poi_fused_14(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK: tl.constexpr, XBLOCK: tl.constexpr):
    xnumel = 9
    ...
    tl.store(out_ptr0 + (y_mod + 160 * x_coord + 1440 * y_div), tmp_data, x_mask)
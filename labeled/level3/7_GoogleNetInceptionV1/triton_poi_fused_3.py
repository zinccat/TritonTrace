...
@triton.jit
def triton_poi_fused_3poi_fused_3(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK: tl.constexpr, XBLOCK: tl.constexpr):
    xnumel = 9
    ...
    tl.store(out_ptr0 + (y_mod_96 + 96 * x_coord + 864 * y_div_96), tmp0, x_mask)
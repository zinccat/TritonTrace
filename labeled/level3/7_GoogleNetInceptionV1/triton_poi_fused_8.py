...
@triton.jit
def triton_poi_fused_8poi_fused_8(input_ptr, output_ptr, num_elements_y, num_elements_x, YBLOCK: tl.constexpr, XBLOCK: tl.constexpr):
    num_elements_y = 768
    num_elements_x = 25
    ...
    y_mod_16 = y_indices % 16
    y_div_16 = y_indices // 16
    temp_data = tl.load(input_ptr + (x_indices_adjusted + 25 * y_indices_adjusted), x_mask & y_mask, eviction_policy='evict_last')
    tl.store(output_ptr + (y_mod_16 + 16 * x_indices_adjusted + 400 * y_div_16), temp_data, x_mask & y_mask)
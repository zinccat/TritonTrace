...
@triton.jit
def triton_poi_fused_cat_39poi_fused_cat_39(
    ...
    condition_less_than_160 = tmp_index_mod_512 < threshold_160
    
    value_from_input0 = tl.load(input_ptr0 + (160 * index_div_512 + index_mod_512), condition_less_than_160, eviction_policy='evict_last', other=0.0)
    value_from_input1 = tl.load(input_ptr1 + index_mod_512, condition_less_than_160, eviction_policy='evict_last', other=0.0)
    ...
    result_0_1 = tl.where(condition_less_than_160, sum_0_1, zero_filled)
    
    threshold_384 = tl.full([1], 384, tl.int64)
    condition_between_160_and_384 = (tmp_index_mod_512 >= threshold_160) & (tmp_index_mod_512 < threshold_384)
    
    value_from_input2 = tl.load(input_ptr2 + (224 * index_div_512 + (-160 + index_mod_512)), condition_between_160_and_384, eviction_policy='evict_last', other=0.0)
    value_from_input3 = tl.load(input_ptr3 + (-160 + index_mod_512), condition_between_160_and_384, eviction_policy='evict_last', other=0.0)
    ...
    result_2_3 = tl.where(condition_between_160_and_384, sum_2_3, zero_filled_2_3)
    ...
    condition_greater_than_448 = tmp_index_mod_512 >= threshold_448
    
    value_from_input6 = tl.load(input_ptr6 + (64 * index_div_512 + (-448 + index_mod_512)), condition_greater_than_448, eviction_policy='evict_last', other=0.0)
    value_from_input7 = tl.load(input_ptr7 + (-448 + index_mod_512), condition_greater_than_448, eviction_policy='evict_last', other=0.0)
    ...
    result_6_7 = tl.where(condition_greater_than_448, sum_6_7, zero_filled_6_7)
    
    result_4_5_or_6_7 = tl.where(condition_between_384_and_448, result_4_5, result_6_7)
    result_2_3_or_4_5_or_6_7 = tl.where(condition_between_160_and_384, result_2_3, result_4_5_or_6_7)
    final_result = tl.where(condition_less_than_160, result_0_1, result_2_3_or_4_5_or_6_7)

...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_15(
    ...
    epsilon = 1e-05
    normalized_var = var_reshaped / 6272.0
    ...
    scale_factor = 1.0001594642002871
    scaled_var = normalized_var * scale_factor
    scaled_var_momentum = scaled_var * momentum

    updated_running_var = scaled_var_momentum + running_var * running_mean_factor

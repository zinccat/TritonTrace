...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_add_relu_22poi_fused__native_batch_norm_legit_functional_add_relu_22(
    ...
    normalized_input = mean - input_data

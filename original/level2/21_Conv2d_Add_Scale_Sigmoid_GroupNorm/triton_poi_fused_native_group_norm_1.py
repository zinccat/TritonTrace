...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr3 + ((x4 // 2)), None, eviction_policy='evict_last')
    tmp8 = tl.load(in_ptr4 + ((x4 // 2)), None, eviction_policy='evict_last')

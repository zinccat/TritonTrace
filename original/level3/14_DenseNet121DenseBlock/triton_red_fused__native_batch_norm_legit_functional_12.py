...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_12(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 512
    rnumel = 125440
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (224*((((r2 + 125440*x1) // 224) % 224)) + 50176*x0 + 6422528*((r2 + 125440*x1) // 50176) + ((r2 % 224))), rmask & xmask, eviction_policy='evict_last', other=0.0)

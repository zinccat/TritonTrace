...
def triton_poi_fused_avg_pool2d_cat_144(in_ptr0, out_ptr0, out_ptr1, out_ptr2, out_ptr3, out_ptr4, out_ptr5, out_ptr6, out_ptr7, out_ptr8, out_ptr9, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr1 + (x2 + 37632*x3), tmp8, xmask)
    tl.store(out_ptr2 + (x2 + 39200*x3), tmp8, xmask)
    tl.store(out_ptr3 + (x2 + 40768*x3), tmp8, xmask)
    tl.store(out_ptr4 + (x2 + 42336*x3), tmp8, xmask)
    tl.store(out_ptr5 + (x2 + 43904*x3), tmp8, xmask)
    tl.store(out_ptr6 + (x2 + 45472*x3), tmp8, xmask)
    tl.store(out_ptr7 + (x2 + 47040*x3), tmp8, xmask)
    tl.store(out_ptr8 + (x2 + 48608*x3), tmp8, xmask)
    tl.store(out_ptr9 + (x2 + 50176*x3), tmp8, xmask)

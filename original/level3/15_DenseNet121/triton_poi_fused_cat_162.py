...
def triton_poi_fused_cat_162(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp28 = tmp0 < tmp27
    tmp29 = tl.load(in_ptr5 + (x0 + 49*((-640) + x1) + 1568*x2), tmp26 & xmask, other=0.0)

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_1(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 448
    rnumel = 17920
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (112*((((r2 + 17920*x1) // 112) % 112)) + 12544*x0 + 802816*((r2 + 17920*x1) // 12544) + ((r2 % 112))), rmask & xmask, eviction_policy='evict_last', other=0.0)

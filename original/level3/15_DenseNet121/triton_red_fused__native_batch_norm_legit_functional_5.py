...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_5(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 256
    rnumel = 7840
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (56*((((r2 + 7840*x1) // 56) % 56)) + 3136*x0 + 200704*((r2 + 7840*x1) // 3136) + ((r2 % 56))), rmask & xmask, eviction_policy='evict_last', other=0.0)

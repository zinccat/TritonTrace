...
def triton_per_fused__native_batch_norm_legit_functional_303(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, out_ptr4, out_ptr6, xnumel, rnumel):
    ...
    r2 = rindex // 49
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (r1 + 49*x0 + 86240*r2), rmask, other=0.0)

...
@triton.jit
def triton_poi_fused_cat_138(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, XBLOCK : tl.constexpr):
    xnumel = 62720
    ...
    tl.store(out_ptr1 + (x0 + 206976*x1), tmp0, xmask)
    tl.store(out_ptr2 + (x0 + 213248*x1), tmp0, xmask)

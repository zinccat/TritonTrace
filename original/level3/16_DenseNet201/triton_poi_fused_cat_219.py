...
def triton_poi_fused_cat_219(in_ptr0, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x0 + 83104*x1), tmp0, xmask)
    tl.store(out_ptr1 + (x0 + 84672*x1), tmp0, xmask)

...
def triton_poi_fused_cat_225(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x0 + 78400*x1), tmp0, xmask)
    tl.store(out_ptr1 + (x0 + 79968*x1), tmp0, xmask)
    tl.store(out_ptr2 + (x0 + 81536*x1), tmp0, xmask)

...
def triton_poi_fused_cat_234(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp18 = tmp0 < tmp17
    tmp19 = tl.load(in_ptr3 + (x0 + 49*((-960) + x1) + 1568*x2), tmp16 & xmask, other=0.0)

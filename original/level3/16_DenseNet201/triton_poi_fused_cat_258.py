...
def triton_poi_fused_cat_258(in_ptr0, out_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x0 + 58016*x1), tmp0, xmask)
    tl.store(out_ptr1 + (x0 + 59584*x1), tmp0, xmask)
    tl.store(out_ptr2 + (x0 + 61152*x1), tmp0, xmask)
    tl.store(out_ptr3 + (x0 + 62720*x1), tmp0, xmask)

...
@triton.jit
def triton_poi_fused_cat_73(in_ptr0, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 62720
    ...
    tl.store(out_ptr0 + (x0 + 219520*x1), tmp0, xmask)
    tl.store(out_ptr1 + (x0 + 225792*x1), tmp0, xmask)

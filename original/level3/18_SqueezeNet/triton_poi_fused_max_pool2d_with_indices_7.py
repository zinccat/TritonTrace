...
def triton_poi_fused_max_pool2d_with_indices_7(in_ptr0, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    x2 = xindex // 5184
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 192*x1 + 20928*x2), xmask)
    tmp1 = tl.load(in_ptr0 + (96 + x0 + 192*x1 + 20928*x2), xmask)
    tmp3 = tl.load(in_ptr0 + (192 + x0 + 192*x1 + 20928*x2), xmask)
    tmp5 = tl.load(in_ptr0 + (10464 + x0 + 192*x1 + 20928*x2), xmask)
    tmp7 = tl.load(in_ptr0 + (10560 + x0 + 192*x1 + 20928*x2), xmask)
    tmp9 = tl.load(in_ptr0 + (10656 + x0 + 192*x1 + 20928*x2), xmask)
    tmp11 = tl.load(in_ptr0 + (20928 + x0 + 192*x1 + 20928*x2), xmask)
    tmp13 = tl.load(in_ptr0 + (21024 + x0 + 192*x1 + 20928*x2), xmask)
    tmp15 = tl.load(in_ptr0 + (21120 + x0 + 192*x1 + 20928*x2), xmask)

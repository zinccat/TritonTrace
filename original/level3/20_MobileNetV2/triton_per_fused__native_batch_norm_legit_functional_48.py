...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_48(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr2, out_ptr4, out_ptr6, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 576
    rnumel = 16
    ...
    r1 = rindex
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 576*r1), xmask, other=0.0)
    tmp1 = tl.load(in_ptr1 + (x0 + 576*r1), xmask, other=0.0)
    tmp2 = tl.load(in_ptr2 + (x0 + 576*r1), xmask, other=0.0)

...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_35(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr2, out_ptr4, out_ptr6, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 240
    rnumel = 71
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp1 = tl.load(in_ptr1 + (x0 + 240*r1), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp2 = tl.load(in_ptr2 + (x0 + 240*r1), rmask & xmask, eviction_policy='evict_first', other=0.0)

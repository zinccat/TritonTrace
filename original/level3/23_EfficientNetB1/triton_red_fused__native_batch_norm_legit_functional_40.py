...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_40(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1440
    rnumel = 125
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (x0 + 80*r2 + 10000*x1), rmask & xmask, eviction_policy='evict_first', other=0.0)

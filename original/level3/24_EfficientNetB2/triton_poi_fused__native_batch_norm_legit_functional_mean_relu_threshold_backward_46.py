...
def triton_poi_fused__native_batch_norm_legit_functional_mean_relu_threshold_backward_46(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr0 + (1408 + x0), xmask, eviction_policy='evict_last')

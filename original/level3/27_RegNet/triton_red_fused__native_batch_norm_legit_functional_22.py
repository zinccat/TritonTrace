...
@triton.jit
def triton_red_fused__native_batch_norm_legit_functional_22(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 512
    rnumel = 98
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp2 = tl.load(in_ptr2 + (x0 + 256*r2 + 25088*x1), rmask & xmask, eviction_policy='evict_first', other=0.0)

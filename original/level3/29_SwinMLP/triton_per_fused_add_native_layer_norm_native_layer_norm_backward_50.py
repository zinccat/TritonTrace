...
def triton_per_fused_add_native_layer_norm_native_layer_norm_backward_50(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel):
    ...
    tmp1 = tl.load(in_ptr0 + (32*x0 + 1568*(r2 // 32) + 37632*x1 + ((r2 % 32))), rmask, other=0.0)
    tmp2 = tl.load(in_ptr1 + (x0 + 49*(r2 // 32)), rmask, eviction_policy='evict_last', other=0.0)
    ...
    tmp33 = tmp30 * tmp32
    tl.store(in_out_ptr0 + (r2 + 768*x3), tmp31, rmask)

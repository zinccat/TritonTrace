...
def triton_poi_fused_add_38(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (32*(((4 + ((x1 % 14))) % 7)) + 224*(((4 + (x1 // 14)) % 7)) + 1568*(x0 // 32) + 18816*((4 + ((x1 % 14))) // 7) + 56448*(triton_helpers.div_floor_integer(4 + (x1 // 14),  7)) + 169344*x2 + ((x0 % 32))), xmask)
    tmp2 = tl.load(in_ptr1 + (7*(((4 + (x1 // 14)) % 7)) + 49*(x0 // 32) + (((4 + ((x1 % 14))) % 7))), xmask, eviction_policy='evict_last')

...
def triton_per_fused__softmax_add_clamp_exp_log_mul_10(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp27 = tmp22 / tmp26
    tl.store(in_out_ptr0 + (r3 + 49*x0 + 2432*x4), tmp27, rmask & xmask)

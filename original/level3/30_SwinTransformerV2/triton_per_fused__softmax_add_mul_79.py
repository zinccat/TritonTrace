...
def triton_per_fused__softmax_add_mul_79(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp24 = tmp19 / tmp23
    tl.store(in_out_ptr0 + (r3 + 49*x0 + 2432*x5), tmp24, rmask & xmask)

...
@triton.jit
def triton_per_fused_add_native_layer_norm_39(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 7840
    rnumel = 192
    ...
    tmp22 = tl.load(in_ptr1 + (r1 + 192*x0), rmask & xmask, other=0.0)
    ...
    tl.store(out_ptr1 + (r1 + 192*x0), tmp29, rmask & xmask)

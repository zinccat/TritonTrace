...
def triton_per_fused_add_native_layer_norm_62(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, rnumel):
    ...
    tmp22 = tl.load(in_ptr1 + (r1 + 384*x0), rmask, other=0.0)

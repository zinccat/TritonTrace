...
@triton.jit
def triton_poi_fused_clone_55(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 15360
    xnumel = 49
    ...
    y5 = yindex // 32
    y6 = yindex
    tmp0 = tl.load(in_ptr0 + (384 + y4 + 1152*x3 + 56448*y2), xmask, eviction_policy='evict_last')

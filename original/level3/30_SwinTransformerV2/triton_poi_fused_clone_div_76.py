...
def triton_poi_fused_clone_div_76(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x4 = ((xindex // 32) % 1176)
    x5 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 32*x2 + 2304*x1 + 112896*x3), xmask)
    tmp1 = tl.load(in_ptr1 + (x4 + 1184*x3), xmask, eviction_policy='evict_last')
    tmp2 = 1e-12

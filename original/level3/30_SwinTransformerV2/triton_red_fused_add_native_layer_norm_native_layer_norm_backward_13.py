...
@triton.jit
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_13(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 31360
    rnumel = 96
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (r2 + 96*((((x0 % 56)) % 7)) + 672*(((x0 // 56) % 7)) + 4704*(((x0 % 56)) // 7) + 37632*(x0 // 392) + 301056*x1), rmask & xmask, eviction_policy='evict_last', other=0.0)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp7 = tl.load(in_ptr0 + (r2 + 96*((((x0 % 56)) % 7)) + 672*(((x0 // 56) % 7)) + 4704*(((x0 % 56)) // 7) + 37632*(x0 // 392) + 301056*x1), rmask & xmask, eviction_policy='evict_first', other=0.0)

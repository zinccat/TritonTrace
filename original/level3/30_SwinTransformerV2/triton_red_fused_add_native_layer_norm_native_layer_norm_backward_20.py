...
@triton.jit
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_20(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 31360
    rnumel = 96
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (r2 + 96*(((((53 + ((x0 % 56))) % 56)) % 7)) + 672*(((((53 + (x0 // 56)) % 56)) % 7)) + 4704*((((53 + ((x0 % 56))) % 56)) // 7) + 37632*(triton_helpers.div_floor_integer(((53 + (x0 // 56)) % 56),  7)) + 301056*x1), rmask & xmask, eviction_policy='evict_last', other=0.0)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp7 = tl.load(in_ptr0 + (r2 + 96*(((((53 + ((x0 % 56))) % 56)) % 7)) + 672*(((((53 + (x0 // 56)) % 56)) % 7)) + 4704*((((53 + ((x0 % 56))) % 56)) // 7) + 37632*(triton_helpers.div_floor_integer(((53 + (x0 // 56)) % 56),  7)) + 301056*x1), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp8 = tl.load(in_ptr1 + (r2), rmask, eviction_policy='evict_last', other=0.0)
        tmp17 = tl.load(in_out_ptr0 + (r2 + 96*x3), rmask & xmask, eviction_policy='evict_first', other=0.0)
        ...
        tmp21 = tmp19 + tmp20
        tmp22 = tmp17 + tmp21
        tl.store(out_ptr2 + (r2 + 96*x3), tmp16, rmask & xmask)
        tl.store(in_out_ptr0 + (r2 + 96*x3), tmp22, rmask & xmask)
    tmp23 = 96.0
    tmp24 = tmp5 / tmp23
    tmp25 = 1e-05
    tmp26 = tmp24 + tmp25
    tmp27 = libdevice.rsqrt(tmp26)
    tmp28 = 0.010416666666666666
    tmp29 = tmp27 * tmp28

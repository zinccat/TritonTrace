...
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_37(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (r2 + 192*((((x0 % 28)) % 7)) + 1344*(((x0 // 28) % 7)) + 9408*(((x0 % 28)) // 7) + 37632*(x0 // 196) + 150528*x1), rmask & xmask, eviction_policy='evict_last', other=0.0)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp7 = tl.load(in_ptr0 + (r2 + 192*((((x0 % 28)) % 7)) + 1344*(((x0 // 28) % 7)) + 9408*(((x0 % 28)) // 7) + 37632*(x0 // 196) + 150528*x1), rmask & xmask, eviction_policy='evict_first', other=0.0)

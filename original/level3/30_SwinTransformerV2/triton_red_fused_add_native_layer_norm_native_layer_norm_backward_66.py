...
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_66(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (r2 + 384*(((((11 + ((x0 % 14))) % 14)) % 7)) + 2688*(((((11 + (x0 // 14)) % 14)) % 7)) + 18816*((((11 + ((x0 % 14))) % 14)) // 7) + 37632*(triton_helpers.div_floor_integer(((11 + (x0 // 14)) % 14),  7)) + 75264*x1), rmask & xmask, eviction_policy='evict_last', other=0.0)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp7 = tl.load(in_ptr0 + (r2 + 384*(((((11 + ((x0 % 14))) % 14)) % 7)) + 2688*(((((11 + (x0 // 14)) % 14)) % 7)) + 18816*((((11 + ((x0 % 14))) % 14)) // 7) + 37632*(triton_helpers.div_floor_integer(((11 + (x0 // 14)) % 14),  7)) + 75264*x1), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp8 = tl.load(in_ptr1 + (r2), rmask, eviction_policy='evict_last', other=0.0)
        tmp17 = tl.load(in_out_ptr0 + (r2 + 384*x3), rmask & xmask, eviction_policy='evict_first', other=0.0)
        ...
        tmp21 = tmp19 + tmp20
        tmp22 = tmp17 + tmp21
        tl.store(out_ptr2 + (r2 + 384*x3), tmp16, rmask & xmask)

...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional__softmax_3(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, xnumel, rnumel):
    xnumel = 32768
    ...
    x4 = xindex
    x1 = ((xindex // 64) % 64)
    tmp0 = tl.load(in_ptr0 + (r3 + 512*x4), None)
    ...
    tmp22 = tmp18 / tmp21
    tl.store(in_out_ptr0 + (r3 + 512*x4), tmp22, None)

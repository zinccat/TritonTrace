...
def triton_poi_fused_cat_26(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp12 = tmp0 < tmp11
    tmp13 = tmp10 & tmp12
    tmp14 = tl.load(in_ptr2 + (128*x1 + ((-64) + x0)), tmp13, eviction_policy='evict_last', other=0.0)
    tmp15 = tl.load(in_ptr3 + ((-64) + x0), tmp13, eviction_policy='evict_last', other=0.0)
    tmp16 = tmp14 + tmp15
    ...
    tmp21 = tmp0 < tmp20
    tmp22 = tmp19 & tmp21
    tmp23 = tl.load(in_ptr4 + (32*x1 + ((-192) + x0)), tmp22, eviction_policy='evict_last', other=0.0)
    tmp24 = tl.load(in_ptr5 + ((-192) + x0), tmp22, eviction_policy='evict_last', other=0.0)
    tmp25 = tmp23 + tmp24
    ...
    tmp30 = tmp0 < tmp29
    tmp31 = tl.load(in_ptr6 + (32*x1 + ((-224) + x0)), tmp28, eviction_policy='evict_last', other=0.0)
